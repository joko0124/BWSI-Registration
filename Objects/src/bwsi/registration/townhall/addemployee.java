...
anywheresoftware.b4a.object.XmlLayoutBuilder _xl = null;
 //BA.debugLineNum = 130;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 132;BA.debugLine="Scale.SetRate(0.5)";
mostCurrent._scale._setrate /*String*/ (mostCurrent.activityBA,0.5);
 //BA.debugLineNum = 133;BA.debugLine="Activity.LoadLayout(\"AddEmployeeLayout\")";
mostCurrent._activity.LoadLayout("AddEmployeeLayout",mostCurrent.activityBA);
 //BA.debugLineNum = 135;BA.debugLine="GlobalVar.CSTitle.Initialize.Size(17).Bold.Append";
mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (17)).Bold().Append(BA.ObjectToCharSequence(("ADD NEW EMPLOYEE"))).PopAll();
 //BA.debugLineNum = 136;BA.debugLine="GlobalVar.CSSubTitle.Initialize.Size(14).Append($";
mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (14)).Append(BA.ObjectToCharSequence(("Add Employee who didn't registered on Pre-registration"))).PopAll();
 //BA.debugLineNum = 138;BA.debugLine="ToolBar.InitMenuListener";
mostCurrent._toolbar.InitMenuListener();
 //BA.debugLineNum = 139;BA.debugLine="ToolBar.Title = GlobalVar.CSTitle";
mostCurrent._toolbar.setTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 140;BA.debugLine="ToolBar.SubTitle = GlobalVar.CSSubTitle";
mostCurrent._toolbar.setSubTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 142;BA.debugLine="Dim jo As JavaObject";
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 143;BA.debugLine="Dim xl As XmlLayoutBuilder";
_xl = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 144;BA.debugLine="jo = ToolBar";
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(mostCurrent._toolbar.getObject()));
 //BA.debugLineNum = 145;BA.debugLine="jo.RunMethod(\"setPopupTheme\", Array(xl.GetResourc";
_jo.RunMethod("setPopupTheme",new Object[]{(Object)(_xl.GetResourceId("style","ToolbarMenu"))});
 //BA.debugLineNum = 146;BA.debugLine="jo.RunMethod(\"setContentInsetStartWithNavigation\"";
_jo.RunMethod("setContentInsetStartWithNavigation",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)))});
 //BA.debugLineNum = 147;BA.debugLine="jo.RunMethod(\"setTitleMarginStart\", Array(0dip))";
_jo.RunMethod("setTitleMarginStart",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)))});
 //BA.debugLineNum = 149;BA.debugLine="InpTyp.Initialize";
_inptyp._initialize /*String*/ (processBA);
 //BA.debugLineNum = 151;BA.debugLine="InpTyp.SetInputType(txtFirstName,Array As Int(Inp";
_inptyp._setinputtype /*String*/ (mostCurrent._txtfirstname,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_text_flag_cap_characters /*int*/ ()});
 //BA.debugLineNum = 152;BA.debugLine="InpTyp.SetInputType(txtMI,Array As Int(InpTyp.TYP";
_inptyp._setinputtype /*String*/ (mostCurrent._txtmi,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_text_flag_cap_characters /*int*/ ()});
 //BA.debugLineNum = 153;BA.debugLine="InpTyp.SetInputType(txtLastName,Array As Int(InpT";
_inptyp._setinputtype /*String*/ (mostCurrent._txtlastname,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_text_flag_cap_characters /*int*/ ()});
 //BA.debugLineNum = 154;BA.debugLine="InpTyp.SetInputType(txtSuffixed,Array As Int(InpT";
_inptyp._setinputtype /*String*/ (mostCurrent._txtsuffixed,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_text_flag_cap_characters /*int*/ ()});
 //BA.debugLineNum = 155;BA.debugLine="InpTyp.SetInputType(txtRemarks,Array As Int(InpTy";
_inptyp._setinputtype /*String*/ (mostCurrent._txtremarks,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_text_flag_cap_sentences /*int*/ ()});
 //BA.debugLineNum = 156;BA.debugLine="InpTyp.SetInputType(txtTableNo,Array As Int(InpTy";
_inptyp._setinputtype /*String*/ (mostCurrent._txttableno,new int[]{_inptyp._type_class_text /*int*/ (),_inptyp._type_text_flag_auto_correct /*int*/ (),_inptyp._type_class_number /*int*/ ()});
 //BA.debugLineNum = 158;BA.debugLine="ActionBarButton.Initialize";
mostCurrent._actionbarbutton.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 159;BA.debugLine="ActionBarButton.ShowUpIndicator = True";
mostCurrent._actionbarbutton.setShowUpIndicator(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 160;BA.debugLine="BTAdmin.Initialize(\"Admin\")";
_btadmin.Initialize(processBA,"Admin");
 //BA.debugLineNum = 161;BA.debugLine="Serial1.Initialize(\"Printer\")";
_serial1.Initialize("Printer");
 //BA.debugLineNum = 163;BA.debugLine="cdTxtBox.Initialize2(Colors.Transparent, Colors.T";
mostCurrent._cdtxtbox.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.Transparent,anywheresoftware.b4a.keywords.Common.Colors.Transparent,(int) (0),(int) (0));
 //BA.debugLineNum = 164;BA.debugLine="txtFirstName.Background = cdTxtBox";
mostCurrent._txtfirstname.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 165;BA.debugLine="txtMI.Background = cdTxtBox";
mostCurrent._txtmi.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 166;BA.debugLine="txtLastName.Background = cdTxtBox";
mostCurrent._txtlastname.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 167;BA.debugLine="txtSuffixed.Background = cdTxtBox";
mostCurrent._txtsuffixed.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 168;BA.debugLine="cboBranches.Background = cdTxtBox";
mostCurrent._cbobranches.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 169;BA.debugLine="cboDivisions.Background = cdTxtBox";
mostCurrent._cbodivisions.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 170;BA.debugLine="txtRemarks.Background = cdTxtBox";
mostCurrent._txtremarks.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 171;BA.debugLine="txtTableNo.Background = cdTxtBox";
mostCurrent._txttableno.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 173;BA.debugLine="IMEKeyboard.Initialize(\"IME\")";
mostCurrent._imekeyboard.Initialize("IME");
 //BA.debugLineNum = 174;BA.debugLine="txtFirstName.RequestFocus";
mostCurrent._txtfirstname.RequestFocus();
 //BA.debugLineNum = 175;BA.debugLine="IMEKeyboard.ShowKeyboard(txtFirstName)";
mostCurrent._imekeyboard.ShowKeyboard((android.view.View)(mostCurrent._txtfirstname.getObject()));
 //BA.debugLineNum = 177;BA.debugLine="cdSave.Initialize2(0xFF1E4369, 20, 0,0xFF268FC2)";
mostCurrent._cdsave.Initialize2((int) (0xff1e4369),(int) (20),(int) (0),(int) (0xff268fc2));
 //BA.debugLineNum = 178;BA.debugLine="btnSave.Background = cdSave";
mostCurrent._btnsave.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdsave.getObject()));
 //BA.debugLineNum = 179;BA.debugLine="cdCancel.Initialize2(0xFFDC143C, 20, 0,0xFFDC3545";
mostCurrent._cdcancel.Initialize2((int) (0xffdc143c),(int) (20),(int) (0),(int) (0xffdc3545));
 //BA.debugLineNum = 180;BA.debugLine="btnCancel.Background = cdCancel";
mostCurrent._btncancel.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdcancel.getObject()));
 //BA.debugLineNum = 182;BA.debugLine="FillBranches(GlobalVar.AreaID)";
_fillbranches(mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 183;BA.debugLine="FillDivisions";
_filldivisions();
 //BA.debugLineNum = 185;BA.debugLine="txtFirstName.Text = \"\"";
mostCurrent._txtfirstname.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 186;BA.debugLine="txtMI.Text = \"\"";
mostCurrent._txtmi.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 187;BA.debugLine="txtLastName.Text = \"\"";
mostCurrent._txtlastname.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 188;BA.debugLine="txtSuffixed.Text = \"\"";
mostCurrent._txtsuffixed.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 189;BA.debugLine="txtRemarks.Text = \"\"";
mostCurrent._txtremarks.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 190;BA.debugLine="txtTableNo.Text = \"\"";
mostCurrent._txttableno.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 191;BA.debugLine="vibratePattern = Array As Long(500, 500, 300, 500";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 420;BA.debugLine="Private Sub AddPeople_OnCancelClicked (View As Vie";
 //BA.debugLineNum = 421;BA.debugLine="If View<>Null Then";
if (_view!= null) { 
 //BA.debugLineNum = 422;BA.debugLine="ToastMessageShow(\"Cancelled!\",False)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence("Cancelled!"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 423;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 424;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 409;BA.debugLine="Private Sub AddPeople_OnItemClick (View As View, S";
 //BA.debugLineNum = 410;BA.debugLine="ToastMessageShow(Selection&\" Selected! (Position";
...
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 412;BA.debugLine="Alert.Initialize.Dismiss2";
_alert.Initialize().Dismiss2();
 //BA.debugLineNum = 414;BA.debugLine="Select Case Position";
switch (_position) {
case 0: {
 break; }
case 1: {
...
public static String  _btncancel_click() throws Exception{
 //BA.debugLineNum = 452;BA.debugLine="Sub btnCancel_Click";
...
public static String  _btnsave_click() throws Exception{
 //BA.debugLineNum = 430;BA.debugLine="Sub btnSave_Click";
 //BA.debugLineNum = 431;BA.debugLine="If Not(ValidEntries) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_validentries())) { 
if (true) return "";};
 //BA.debugLineNum = 433;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtMI.Text)";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtmi.getText()))<=0) { 
 //BA.debugLineNum = 434;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtSuffixe";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtsuffixed.getText()))<=0) { 
 //BA.debugLineNum = 435;BA.debugLine="EmpFullName = txtFirstName.Text & \" \" & txtLast";
mostCurrent._empfullname = mostCurrent._txtfirstname.getText()+" "+mostCurrent._txtlastname.getText();
 }else {
 //BA.debugLineNum = 437;BA.debugLine="EmpFullName = txtFirstName.Text & \" \" & txtLast";
mostCurrent._empfullname = mostCurrent._txtfirstname.getText()+" "+mostCurrent._txtlastname.getText()+" "+mostCurrent._txtsuffixed.getText();
 ...
 //BA.debugLineNum = 440;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtSuffixe";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtsuffixed.getText()))<=0) { 
 //BA.debugLineNum = 441;BA.debugLine="EmpFullName = txtFirstName.Text & \" \" & txtMI.T";
mostCurrent._empfullname = mostCurrent._txtfirstname.getText()+" "+mostCurrent._txtmi.getText()+" "+mostCurrent._txtlastname.getText();
 }else {
 //BA.debugLineNum = 443;BA.debugLine="EmpFullName = txtFirstName.Text & \" \" & txtMI.T";
mostCurrent._empfullname = mostCurrent._txtfirstname.getText()+" "+mostCurrent._txtmi.getText()+" "+mostCurrent._txtlastname.getText()+" "+mostCurrent._txtsuffixed.getText();
 ...
 //BA.debugLineNum = 447;BA.debugLine="vibration.vibratePattern(vibratePattern, 0)";
_vibration.vibratePattern(processBA,_vibratepattern,(int) (0));
 //BA.debugLineNum = 448;BA.debugLine="ConfirmRegister(EmpFullName)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 222;BA.debugLine="Private Sub ConfirmRegister (sEmpName As String)";
 //BA.debugLineNum = 223;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 225;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(("CONFIRM REGISTRATION")).SetMessage(("Do you want to Add and Register ")+anywheresoftware.b4a.keywords.Common.CRLF+_sempname+("?")).SetPositiveText("YES").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetNegativeText("NO").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"RegisterEmp").SetOnNegativeClicked(mostCurrent.activityBA,"RegisterEmp").SetOnViewBinder(mostCurrent.activityBA,"RegFontSizeBinder");
 //BA.debugLineNum = 243;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 244;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _b = null;
 //BA.debugLineNum = 785;BA.debugLine="Sub CreateScaledBitmap(Original As Bitmap, NewWidt";
 //BA.debugLineNum = 786;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 787;BA.debugLine="Dim b As Bitmap";
_b = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 788;BA.debugLine="b = r.RunStaticMethod(\"android.graphics.Bitmap\",";
_b = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(_r.RunStaticMethod("android.graphics.Bitmap","createScaledBitmap",new Object[]{(Object)(_original.getObject()),(Object)(_newwidth),(Object)(_newheight),(Object)(anywheresoftware.b4a.keywords.Common.True)},new String[]{"android.graphics.Bitmap","java.lang.int","java.lang.int","java.lang.boolean"})));
 //BA.debugLineNum = 789;BA.debugLine="Return b";
if (true) return _b;
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 530;BA.debugLine="Private Sub EntryError_OnPositiveClicked (View As";
 //BA.debugLineNum = 531;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 532;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 533;BA.debugLine="vibration.vibrateCancel";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 536;BA.debugLine="Private Sub EntryErrorBinder_OnBindView (View As V";
 //BA.debugLineNum = 537;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 538;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 539;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 540;BA.debugLine="Dim lbl As Label = View";
...
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 541;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 542;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf071)))+"  "));
 //BA.debugLineNum = 543;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 545;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 548;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 549;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 550;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 551;BA.debugLine="lbl.TextColor = Colors.Gray";
...
//C
this.state = 1;
 //BA.debugLineNum = 794;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 796;BA.debugLine="cboBranches.Clear";
parent.mostCurrent._cbobranches.Clear();
 //BA.debugLineNum = 798;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblBranches";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblBranches "+"WHERE AreaID = "+BA.NumberToString(_iareaid);
 //BA.debugLineNum = 800;BA.debugLine="Starter.DBCon.ExecQuery (Starter.strCriteria)";
parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(parent.mostCurrent._starter._strcriteria /*String*/ );
 //BA.debugLineNum = 802;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("112058633",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 803;BA.debugLine="Try";
if (true) break;
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 804;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 805;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
...
//C
this.state = 7;
 //BA.debugLineNum = 807;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 808;BA.debugLine="cboBranches.Clear";
parent.mostCurrent._cbobranches.Clear();
 //BA.debugLineNum = 809;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 810;BA.debugLine="cboBranches.Add(RS.GetString(\"BranchName\"))";
...
//C
this.state = 13;
 //BA.debugLineNum = 813;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("112058644",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
this.catchState = 0;
 //BA.debugLineNum = 819;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("112058650",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
//C
this.state = 1;
 //BA.debugLineNum = 825;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 827;BA.debugLine="cboDivisions.Clear";
parent.mostCurrent._cbodivisions.Clear();
 //BA.debugLineNum = 829;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblDivisions";
parent.mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblDivisions";
 //BA.debugLineNum = 830;BA.debugLine="Starter.DBCon.ExecQuery (Starter.strCriteria)";
parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(parent.mostCurrent._starter._strcriteria /*String*/ );
 //BA.debugLineNum = 832;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("112124168",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
this.state = 4;
this.catchState = 15;
 //BA.debugLineNum = 834;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 835;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succe";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 17;
return;
case 17:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 836;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 837;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 838;BA.debugLine="cboDivisions.Clear";
parent.mostCurrent._cbodivisions.Clear();
 //BA.debugLineNum = 839;BA.debugLine="Do While RS.NextRow";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 840;BA.debugLine="cboDivisions.Add(RS.GetString(\"DivisionName\"))";
...
anywheresoftware.b4a.keywords.Common.LogImpl("112124179",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = 16;
;
 //BA.debugLineNum = 846;BA.debugLine="Log($\"List of Division Records = ${NumberFormat2";
anywheresoftware.b4a.keywords.Common.LogImpl("112124182",("List of Division Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._cbodivisions.getSize()))+" Divisions Records"),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("112124185",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
mostCurrent._linset0 = mostCurrent._esc+"$"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)));
 //BA.debugLineNum = 122;BA.debugLine="Private LMARGIN0 As String = GS & \"L\" & Chr(0x0)";
mostCurrent._lmargin0 = mostCurrent._gs+"L"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)));
 //BA.debugLineNum = 123;BA.debugLine="Private WIDTH0 As String = GS & \"W\" & Chr(0xff) &";
mostCurrent._width0 = mostCurrent._gs+"W"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xff)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xff)));
 //BA.debugLineNum = 124;BA.debugLine="Private CHARSPACING0 As String = ESC & \" \" & Chr(";
mostCurrent._charspacing0 = mostCurrent._esc+" "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0)));
 //BA.debugLineNum = 125;BA.debugLine="Private CHARFONT0 As String = ESC & \"M\" & Chr(0)";
mostCurrent._charfont0 = mostCurrent._esc+"M"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0)));
 //BA.debugLineNum = 126;BA.debugLine="Dim DEFAULTS As String =  CHARSPACING0 & CHARFONT";
...
//C
this.state = 1;
 //BA.debugLineNum = 743;BA.debugLine="Log(\"Connected: \" & Success)";
anywheresoftware.b4a.keywords.Common.LogImpl("111927553","Connected: "+BA.ObjectToString(_success),0);
 //BA.debugLineNum = 745;BA.debugLine="If Success = False Then";
if (true) break;
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 750;BA.debugLine="StartPrinter";
_startprinter();
 if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 753;BA.debugLine="Dim initPrinter() As Byte";
_initprinter = new byte[(int) (0)];
;
 //BA.debugLineNum = 755;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 756;BA.debugLine="TMPrinter.Initialize2(Serial1.OutputStream, \"win";
parent._tmprinter.Initialize2(parent._serial1.getOutputStream(),"windows-1252");
 //BA.debugLineNum = 757;BA.debugLine="oStream.Initialize(Serial1.InputStream, Serial1.";
parent._ostream.Initialize(processBA,parent._serial1.getInputStream(),parent._serial1.getOutputStream(),"LogoPrint");
 //BA.debugLineNum = 758;BA.debugLine="Logo.Initialize(File.DirAssets, \"Stub-Header-Tow";
parent._logo.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Stub-Header-Townhall.png");
 //BA.debugLineNum = 759;BA.debugLine="LogoBMP = CreateScaledBitmap(Logo, Logo.Width, L";
parent._logobmp = _createscaledbitmap(parent._logo,parent._logo.getWidth(),parent._logo.getHeight());
 //BA.debugLineNum = 760;BA.debugLine="Log(DeviceName)";
anywheresoftware.b4a.keywords.Common.LogImpl("111927570",parent._devicename,0);
 //BA.debugLineNum = 762;BA.debugLine="WoosimCMD.InitializeStatic(\"com.woosim.printer.W";
parent._woosimcmd.InitializeStatic("com.woosim.printer.WoosimCmd");
 //BA.debugLineNum = 763;BA.debugLine="WoosimImage.InitializeStatic(\"com.woosim.printer";
parent._woosimimage.InitializeStatic("com.woosim.printer.WoosimImage");
 //BA.debugLineNum = 765;BA.debugLine="initPrinter = WoosimCMD.RunMethod(\"initPrinter\",";
_initprinter = (byte[])(parent._woosimcmd.RunMethod("initPrinter",(Object[])(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 766;BA.debugLine="PrintLogo = WoosimImage.RunMethod(\"printBitmap\",";
parent._printlogo = (byte[])(parent._woosimimage.RunMethod("printBitmap",new Object[]{(Object)(0),(Object)(0),(Object)(420),(Object)(220),(Object)(parent._logobmp.getObject())}));
 //BA.debugLineNum = 768;BA.debugLine="oStream.Write(initPrinter)";
parent._ostream.Write(_initprinter);
 //BA.debugLineNum = 769;BA.debugLine="oStream.Write(WoosimCMD.RunMethod(\"setPageMode\",";
parent._ostream.Write((byte[])(parent._woosimcmd.RunMethod("setPageMode",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 770;BA.debugLine="oStream.Write(PrintLogo)";
parent._ostream.Write(parent._printlogo);
 //BA.debugLineNum = 771;BA.debugLine="oStream.Write(WoosimCMD.RunMethod(\"PM_setStdMode";
parent._ostream.Write((byte[])(parent._woosimcmd.RunMethod("PM_setStdMode",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 772;BA.debugLine="oStream.Write(PrintLogo)";
parent._ostream.Write(parent._printlogo);
 //BA.debugLineNum = 774;BA.debugLine="Sleep(500)";
...
this.state = 6;
;
 //BA.debugLineNum = 775;BA.debugLine="TMPrinter.WriteLine(PrintBuffer)";
parent._tmprinter.WriteLine(parent._printbuffer);
 //BA.debugLineNum = 776;BA.debugLine="Log(PrintBuffer)";
anywheresoftware.b4a.keywords.Common.LogImpl("111927586",parent._printbuffer,0);
 //BA.debugLineNum = 777;BA.debugLine="TMPrinter.Flush";
parent._tmprinter.Flush();
 //BA.debugLineNum = 778;BA.debugLine="Sleep(600)";
...
this.state = 6;
;
 //BA.debugLineNum = 779;BA.debugLine="ShowSuccessMsg($\"SUCCESS\"$, $\"Stub was successfu";
_showsuccessmsg(("SUCCESS"),("Stub was successfully printed.")+anywheresoftware.b4a.keywords.Common.CRLF+("Tap OK to Continue..."));
 //BA.debugLineNum = 780;BA.debugLine="TMPrinter.Close";
parent._tmprinter.Close();
 //BA.debugLineNum = 781;BA.debugLine="Serial1.Disconnect";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 316;BA.debugLine="Private Sub PrinterBinder_OnBindView (View As View";
 //BA.debugLineNum = 317;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 318;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 319;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 320;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 321;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 322;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf071)))+"  "));
 //BA.debugLineNum = 323;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 325;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 328;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 329;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 330;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 331;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 311;BA.debugLine="Private Sub PrinterError_OnPositiveClicked (View A";
 //BA.debugLineNum = 312;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 313;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
...
int _regtableno = 0;
int _attendstatus = 0;
 //BA.debugLineNum = 606;BA.debugLine="Private Sub PrintStub(iRegID As Int)";
 //BA.debugLineNum = 607;BA.debugLine="Dim rsData As Cursor";
_rsdata = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 608;BA.debugLine="Dim StubNo As String";
_stubno = "";
 //BA.debugLineNum = 609;BA.debugLine="Dim RegFullName As String";
_regfullname = "";
 //BA.debugLineNum = 610;BA.debugLine="Dim RegBranchName As String";
_regbranchname = "";
 //BA.debugLineNum = 611;BA.debugLine="Dim RegDivision As String";
_regdivision = "";
 //BA.debugLineNum = 612;BA.debugLine="Dim RegTableNo As Int";
_regtableno = 0;
 //BA.debugLineNum = 613;BA.debugLine="Dim AttendStatus As Int";
_attendstatus = 0;
 //BA.debugLineNum = 615;BA.debugLine="ProgressDialogShow2($\"Stub Printing.  Please Wait";
...
try { //BA.debugLineNum = 618;BA.debugLine="Starter.strCriteria = \"SELECT Employees.RegNo, E";
mostCurrent._starter._strcriteria /*String*/  = "SELECT Employees.RegNo, Employees.FullName, "+"Branches.BranchName, Divisions.DivisionName, Employees.TableNo, "+"Employees.WillAttend AS AttendStatus "+"FROM tblRegistration AS Employees "+"INNER JOIN tblBranches AS Branches ON Employees.BranchID = Branches.BranchID "+"INNER JOIN tblDivisions AS Divisions ON Employees.DivisionID = Divisions.DivisionID "+"WHERE Employees.RegID = "+BA.NumberToString(_iregid)+" "+"AND Employees.WasRegistered = 1";
 //BA.debugLineNum = 627;BA.debugLine="rsData = Starter.DBCon.ExecQuery(Starter.strCrit";
_rsdata = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 628;BA.debugLine="LogColor(Starter.strCriteria, Colors.Magenta)";
anywheresoftware.b4a.keywords.Common.LogImpl("111796502",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
 //BA.debugLineNum = 630;BA.debugLine="If rsData.RowCount > 0 Then";
if (_rsdata.getRowCount()>0) { 
 //BA.debugLineNum = 631;BA.debugLine="rsData.Position = 0";
_rsdata.setPosition((int) (0));
 //BA.debugLineNum = 632;BA.debugLine="StubNo = rsData.GetString(\"RegNo\")";
_stubno = _rsdata.GetString("RegNo");
 //BA.debugLineNum = 633;BA.debugLine="RegFullName = rsData.GetString(\"FullName\")";
_regfullname = _rsdata.GetString("FullName");
 //BA.debugLineNum = 634;BA.debugLine="RegBranchName = rsData.GetString(\"BranchName\")";
_regbranchname = _rsdata.GetString("BranchName");
 //BA.debugLineNum = 635;BA.debugLine="RegDivision = rsData.GetString(\"DivisionName\")";
_regdivision = _rsdata.GetString("DivisionName");
 //BA.debugLineNum = 636;BA.debugLine="RegTableNo = rsData.GetInt(\"TableNo\")";
_regtableno = _rsdata.GetInt("TableNo");
 //BA.debugLineNum = 637;BA.debugLine="AttendStatus = rsData.GetInt(\"AttendStatus\")";
_attendstatus = _rsdata.GetInt("AttendStatus");
 }else {
 //BA.debugLineNum = 639;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 642;BA.debugLine="PrintBuffer =  ESC & \"@\" _ 					& ESC & Chr(97)";
_printbuffer = mostCurrent._esc+"@"+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (49)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (48)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (33)))+("STUB NO.: ")+mostCurrent._bold+_stubno+anywheresoftware.b4a.keywords.Common.CRLF+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (49)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (8)))+_regfullname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regbranchname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regdivision+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._high+mostCurrent._reverse+("                  ")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._highwide+mostCurrent._unreverse+("TABLE NO.: ")+BA.NumberToString(_regtableno)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (16)))+("Sit back, Listen & Learn!")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+"------------------------------------------"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (48)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (33)))+("DINNER STUB")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (49)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (112)))+_stubno+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (8)))+_regfullname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regbranchname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regdivision+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._high+mostCurrent._reverse+("                  ")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._highwide+mostCurrent._unreverse+("TABLE NO.: ")+BA.NumberToString(_regtableno)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+"------------------------------------------"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (48)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (33)))+("LUNCH STUB")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (49)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (112)))+_stubno+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (8)))+_regfullname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regbranchname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regdivision+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._high+mostCurrent._reverse+("                  ")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._highwide+mostCurrent._unreverse+("TABLE NO.: ")+BA.NumberToString(_regtableno)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+"------------------------------------------"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (48)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (33)))+("RAFFLE STUB")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (97)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (49)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (112)))+_stubno+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (8)))+_regfullname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regbranchname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)))+mostCurrent._esc+"t"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (14)))+_regdivision+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._high+mostCurrent._reverse+("                  ")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._highwide+mostCurrent._unreverse+("TABLE NO.: ")+BA.NumberToString(_regtableno)+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (10)))+mostCurrent._esc+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (73)));
 //BA.debugLineNum = 684;BA.debugLine="StartPrinter";
_startprinter();
 } 
       catch (Exception e27) {
			processBA.setLastException(e27); //BA.debugLineNum = 686;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 687;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("111796561",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 270;BA.debugLine="Private Sub RegFontSizeBinder_OnBindView (View As";
 //BA.debugLineNum = 271;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 272;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 273;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 274;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 275;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 276;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf059)))+"  "));
 //BA.debugLineNum = 277;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 279;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 282;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 283;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 284;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 285;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 248;BA.debugLine="Private Sub RegisterEmp_OnNegativeClicked (View As";
 //BA.debugLineNum = 249;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 250;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 251;BA.debugLine="vibration.vibrateCancel";
_vibration.vibrateCancel(processBA);
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 255;BA.debugLine="Private Sub RegisterEmp_OnPositiveClicked (View As";
...
_vibration.vibrateCancel(processBA);
 //BA.debugLineNum = 260;BA.debugLine="If Not(SaveEmployeeRegistration) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_saveemployeeregistration())) { 
 //BA.debugLineNum = 261;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Unable to Add New Em";
_showentryerror(("ERROR"),("Unable to Add New Employee data due to ")+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)));
 ...
 //BA.debugLineNum = 264;BA.debugLine="GlobalVar.NewRegID = DBFunctions.GetIDByCode(\"Reg";
mostCurrent._globalvar._newregid /*int*/  = mostCurrent._dbfunctions._getidbycode /*int*/ (mostCurrent.activityBA,"RegID","tblRegistration","RegNo",mostCurrent._globalvar._newregno /*String*/ );
 //BA.debugLineNum = 266;BA.debugLine="PrintStub(GlobalVar.NewRegID)";
...
String _timereg = "";
int _ibranchid = 0;
 //BA.debugLineNum = 555;BA.debugLine="Private Sub SaveEmployeeRegistration() As Boolean";
 //BA.debugLineNum = 556;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 557;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 558;BA.debugLine="Dim RegSeq, NoPrint As Int";
_regseq = 0;
_noprint = 0;
 //BA.debugLineNum = 561;BA.debugLine="Dim sLastName, sFirstName, sMI, sSuffixed, EmpNam";
_slastname = "";
_sfirstname = "";
_smi = "";
_ssuffixed = "";
_empname = "";
 //BA.debugLineNum = 562;BA.debugLine="Dim Remarks, DivisionID, TableNo, AddedBy As Stri";
_remarks = "";
_divisionid = "";
_tableno = "";
_addedby = "";
 //BA.debugLineNum = 563;BA.debugLine="Dim TimeReg As String";
_timereg = "";
 //BA.debugLineNum = 564;BA.debugLine="Dim iBranchID As Int";
_ibranchid = 0;
 //BA.debugLineNum = 566;BA.debugLine="ProgressDialogShow2($\"Saving Employee Data...\"$,";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,BA.ObjectToCharSequence(("Saving Employee Data...")),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 567;BA.debugLine="iBranchID = DBFunctions.GetIDByCode(\"BranchID\", \"";
_ibranchid = mostCurrent._dbfunctions._getidbycode /*int*/ (mostCurrent.activityBA,"BranchID","tblBranches","BranchName",mostCurrent._cbobranches.getSelectedItem());
 //BA.debugLineNum = 569;BA.debugLine="sFirstName = txtFirstName.Text";
_sfirstname = mostCurrent._txtfirstname.getText();
 //BA.debugLineNum = 570;BA.debugLine="sMI = txtMI.Text";
_smi = mostCurrent._txtmi.getText();
 //BA.debugLineNum = 571;BA.debugLine="sLastName = txtLastName.Text";
_slastname = mostCurrent._txtlastname.getText();
 //BA.debugLineNum = 572;BA.debugLine="sSuffixed = txtSuffixed.Text";
_ssuffixed = mostCurrent._txtsuffixed.getText();
 //BA.debugLineNum = 573;BA.debugLine="EmpName = EmpFullName";
_empname = mostCurrent._empfullname;
 //BA.debugLineNum = 574;BA.debugLine="Remarks = txtRemarks.Text";
_remarks = mostCurrent._txtremarks.getText();
 //BA.debugLineNum = 575;BA.debugLine="TableNo = txtTableNo.Text";
_tableno = mostCurrent._txttableno.getText();
 //BA.debugLineNum = 576;BA.debugLine="DivisionID = DBFunctions.GetIDByCode(\"DivisionID\"";
_divisionid = BA.NumberToString(mostCurrent._dbfunctions._getidbycode /*int*/ (mostCurrent.activityBA,"DivisionID","tblDivisions","DivisionName",mostCurrent._cbodivisions.getSelectedItem()));
 //BA.debugLineNum = 578;BA.debugLine="AddedBy = GlobalVar.AssignedEmp";
_addedby = mostCurrent._globalvar._assignedemp /*String*/ ;
 //BA.debugLineNum = 580;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 581;BA.debugLine="DateTime.TimeFormat = \"HH:mm:ss\"";
anywheresoftware.b4a.keywords.Common.DateTime.setTimeFormat("HH:mm:ss");
 //BA.debugLineNum = 582;BA.debugLine="TimeReg = DateTime.Time(lngDateTime)";
_timereg = anywheresoftware.b4a.keywords.Common.DateTime.Time(_lngdatetime);
 //BA.debugLineNum = 584;BA.debugLine="RegSeq = DBFunctions.GetSeqNo";
_regseq = mostCurrent._dbfunctions._getseqno /*int*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 586;BA.debugLine="NoPrint = 1";
_noprint = (int) (1);
 //BA.debugLineNum = 588;BA.debugLine="GlobalVar.NewRegNo = DBFunctions.GetNewStubNo";
mostCurrent._globalvar._newregno /*String*/  = mostCurrent._dbfunctions._getnewstubno /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 590;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 591;BA.debugLine="Try";
try { //BA.debugLineNum = 592;BA.debugLine="Starter.strCriteria=\"INSERT INTO tblRegistration";
mostCurrent._starter._strcriteria /*String*/  = "INSERT INTO tblRegistration VALUES ("+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Null)+", ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
 //BA.debugLineNum = 593;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(mostCurrent._globalvar._newregno /*String*/ ),(Object)(_ibranchid),(Object)(_divisionid),(Object)(_tableno),(Object)(_slastname),(Object)(_sfirstname),(Object)(_smi),(Object)(_ssuffixed),(Object)(_empname),(Object)(("1")),(Object)(("0")),anywheresoftware.b4a.keywords.Common.Null,(Object)(("1")),(Object)(_remarks),(Object)(("1")),(Object)(_timereg),(Object)(_regseq),(Object)(("1")),(Object)(_noprint),(Object)(_timereg),(Object)(_addedby)}));
 //BA.debugLineNum = 594;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 595;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e32) {
			processBA.setLastException(e32); //BA.debugLineNum = 597;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 598;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("111730987",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 600;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 602;BA.debugLine="Return bRetVal";
...
anywheresoftware.b4a.objects.collections.List _items = null;
 //BA.debugLineNum = 382;BA.debugLine="Private Sub ShowAddPerson";
 //BA.debugLineNum = 383;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 385;BA.debugLine="Dim items As List";
_items = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 386;BA.debugLine="items.Initialize";
_items.Initialize();
 //BA.debugLineNum = 387;BA.debugLine="items.Add(\"New Employee\")";
_items.Add((Object)("New Employee"));
 //BA.debugLineNum = 388;BA.debugLine="items.Add(\"Guest\")";
_items.Add((Object)("Guest"));
 //BA.debugLineNum = 390;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialog").SetStyle(_alert.getSTYLE_ACTIONSHEET()).SetTitle("Select an Option").SetTitleColor(anywheresoftware.b4a.keywords.Common.Colors.Black).SetCancelText("Cancel").SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOthers((java.util.ArrayList)(_items.getObject())).SetActionsheetTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnCancelClicked(mostCurrent.activityBA,"AddPeople").SetOnItemClickListener(mostCurrent.activityBA,"AddPeople");
 //BA.debugLineNum = 404;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD).SetCanc";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject())).SetCancelBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 405;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 508;BA.debugLine="Private Sub ShowEntryError(sTitle As String, sMsg";
...
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"EntryError").SetOnViewBinder(mostCurrent.activityBA,"EntryErrorBinder");
 //BA.debugLineNum = 525;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 526;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 289;BA.debugLine="Private Sub ShowPrinterError(sTitle As String, sMs";
 //BA.debugLineNum = 290;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 292;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"PrinterError").SetOnViewBinder(mostCurrent.activityBA,"PrinterBinder");
 //BA.debugLineNum = 306;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 307;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 335;BA.debugLine="Private Sub ShowSuccessMsg(sTitle As String, sMsg";
 //BA.debugLineNum = 336;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 338;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"SuccessMsg").SetOnViewBinder(mostCurrent.activityBA,"SuccessBinder");
 //BA.debugLineNum = 352;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 353;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
int _i = 0;
 //BA.debugLineNum = 691;BA.debugLine="Sub StartPrinter";
 //BA.debugLineNum = 693;BA.debugLine="PairedDevices.Initialize";
_paireddevices.Initialize();
 //BA.debugLineNum = 695;BA.debugLine="Try";
try { //BA.debugLineNum = 696;BA.debugLine="PairedDevices = Serial1.GetPairedDevices";
_paireddevices = _serial1.GetPairedDevices();
 } 
       catch (Exception e5) {
			processBA.setLastException(e5); //BA.debugLineNum = 698;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Getting Pa";
_showprintererror(("PRINTER ERROR"),("Getting Paired Devices..."));
 //BA.debugLineNum = 699;BA.debugLine="TMPrinter.Close";
_tmprinter.Close();
 //BA.debugLineNum = 700;BA.debugLine="Serial1.Disconnect";
_serial1.Disconnect();
 };
 //BA.debugLineNum = 703;BA.debugLine="If PairedDevices.Size = 0 Then";
if (_paireddevices.getSize()==0) { 
 //BA.debugLineNum = 704;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Error Conn";
...
if (true) return "";
 ...
 //BA.debugLineNum = 708;BA.debugLine="If PairedDevices.Size = 1 Then";
if (_paireddevices.getSize()==1) { 
 //BA.debugLineNum = 709;BA.debugLine="Try";
try { //BA.debugLineNum = 710;BA.debugLine="DeviceName=PairedDevices.Getkeyat(0)";
_devicename = BA.ObjectToString(_paireddevices.GetKeyAt((int) (0)));
 //BA.debugLineNum = 711;BA.debugLine="DeviceMac=PairedDevices.GetValueAt(0)";
_devicemac = BA.ObjectToString(_paireddevices.GetValueAt((int) (0)));
 //BA.debugLineNum = 712;BA.debugLine="Log(DeviceName & \" -> \" & DeviceMac)";
anywheresoftware.b4a.keywords.Common.LogImpl("111862037",_devicename+" -> "+_devicemac,0);
 //BA.debugLineNum = 714;BA.debugLine="Serial1.ConnectInsecure(BTAdmin, DeviceMac,1)";
_serial1.ConnectInsecure(processBA,_btadmin,_devicemac,(int) (1));
 //BA.debugLineNum = 715;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 } 
       catch (Exception e21) {
			processBA.setLastException(e21); //BA.debugLineNum = 717;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Printer C";
_showprintererror(("PRINTER ERROR"),("Printer Connection Error..."));
 //BA.debugLineNum = 718;BA.debugLine="TMPrinter.Close";
_tmprinter.Close();
 //BA.debugLineNum = 719;BA.debugLine="Serial1.Disconnect";
_serial1.Disconnect();
 };
 }else {
 //BA.debugLineNum = 722;BA.debugLine="FoundDevices.Initialize";
_founddevices.Initialize();
 //BA.debugLineNum = 724;BA.debugLine="For i = 0 To PairedDevices.Size - 1";
{
final int step27 = 1;
final int limit27 = (int) (_paireddevices.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit27 ;_i = _i + step27 ) {
 //BA.debugLineNum = 725;BA.debugLine="FoundDevices.Add(PairedDevices.GetKeyAt(i))";
_founddevices.Add(_paireddevices.GetKeyAt(_i));
 //BA.debugLineNum = 726;BA.debugLine="DeviceName=PairedDevices.Getkeyat(i)";
_devicename = BA.ObjectToString(_paireddevices.GetKeyAt(_i));
 //BA.debugLineNum = 727;BA.debugLine="DeviceMac=PairedDevices.GetValueAt(i)";
_devicemac = BA.ObjectToString(_paireddevices.GetValueAt(_i));
 //BA.debugLineNum = 728;BA.debugLine="Log(DeviceName & \" -> \" & DeviceMac)";
anywheresoftware.b4a.keywords.Common.LogImpl("111862053",_devicename+" -> "+_devicemac,0);
 //BA.debugLineNum = 729;BA.debugLine="Serial1.ConnectInsecure(BTAdmin, DeviceMac,1)";
_serial1.ConnectInsecure(processBA,_btadmin,_devicemac,(int) (1));
 //BA.debugLineNum = 730;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 731;BA.debugLine="Exit";
if (true) break;
 }
};
 //BA.debugLineNum = 734;BA.debugLine="Res = InputList(FoundDevices, \"Choose Device\", -";
_res = anywheresoftware.b4a.keywords.Common.InputList(_founddevices,BA.ObjectToCharSequence("Choose Device"),(int) (-1),mostCurrent.activityBA);
 //BA.debugLineNum = 736;BA.debugLine="If Res <> DialogResponse.CANCEL Then";
if (_res!=anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 737;BA.debugLine="Serial1.Connect(PairedDevices.Get(FoundDevices.";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 363;BA.debugLine="Private Sub SuccessBinder_OnBindView (View As View";
 //BA.debugLineNum = 364;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 365;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 366;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 367;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 368;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 369;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color((int) (mostCurrent._globalvar._poscolor /*double*/ )).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf164)))+"  "));
 //BA.debugLineNum = 370;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 372;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 375;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 376;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 377;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 378;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 357;BA.debugLine="Private Sub SuccessMsg_OnPositiveClicked (View As";
 //BA.debugLineNum = 358;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 359;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 215;BA.debugLine="Sub ToolBar_MenuItemClick (Item As ACMenuItem)";
 //BA.debugLineNum = 216;BA.debugLine="Select Case Item.Id";
...
public static String  _toolbar_navigationitemclick() throws Exception{
 //BA.debugLineNum = 211;BA.debugLine="Sub ToolBar_NavigationItemClick";
...
public static String  _txtfirstname_enterpressed() throws Exception{
 //BA.debugLineNum = 854;BA.debugLine="Sub txtFirstName_EnterPressed";
 //BA.debugLineNum = 855;BA.debugLine="txtMI.RequestFocus";
...
public static boolean  _validentries() throws Exception{
 //BA.debugLineNum = 456;BA.debugLine="Private Sub ValidEntries() As Boolean";
 //BA.debugLineNum = 458;BA.debugLine="Try";
try { //BA.debugLineNum = 459;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtFirstNa";
...
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 461;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Employee First Name";
_showentryerror(("ERROR"),("Employee First Name cannot be blank!"));
 //BA.debugLineNum = 462;BA.debugLine="txtFirstName.RequestFocus";
mostCurrent._txtfirstname.RequestFocus();
 //BA.debugLineNum = 463;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 467;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtLastNam";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtlastname.getText()))<=0) { 
 //BA.debugLineNum = 468;BA.debugLine="vibration.vibrateOnce(1500)";
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 469;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Employee Last Name";
_showentryerror(("ERROR"),("Employee Last Name cannot be blank!"));
 //BA.debugLineNum = 470;BA.debugLine="txtLastName.RequestFocus";
mostCurrent._txtlastname.RequestFocus();
 //BA.debugLineNum = 471;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 474;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(cboBranche";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._cbobranches.getSelectedItem()))<=0) { 
 //BA.debugLineNum = 475;BA.debugLine="vibration.vibrateOnce(1500)";
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 476;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Employee Name canno";
_showentryerror(("ERROR"),("Employee Name cannot be blank!"));
 //BA.debugLineNum = 477;BA.debugLine="cboBranches.RequestFocus";
mostCurrent._cbobranches.RequestFocus();
 //BA.debugLineNum = 478;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 481;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(cboDivisio";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._cbodivisions.getSelectedItem()))<=0) { 
 //BA.debugLineNum = 482;BA.debugLine="vibration.vibrateOnce(1500)";
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 483;BA.debugLine="ShowEntryError($\"ERROR\"$,$\"Employee Division ca";
_showentryerror(("ERROR"),("Employee Division cannot be blank!"));
 //BA.debugLineNum = 484;BA.debugLine="cboDivisions.RequestFocus";
mostCurrent._cbodivisions.RequestFocus();
 //BA.debugLineNum = 485;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 488;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtRemarks";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtremarks.getText()))<=0) { 
 //BA.debugLineNum = 489;BA.debugLine="vibration.vibrateOnce(1500)";
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 490;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Remarks cannot be b";
_showentryerror(("ERROR"),("Remarks cannot be blank!"));
 //BA.debugLineNum = 491;BA.debugLine="txtRemarks.RequestFocus";
mostCurrent._txtremarks.RequestFocus();
 //BA.debugLineNum = 492;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 };
 //BA.debugLineNum = 495;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtTableNo";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txttableno.getText()))<=0) { 
 //BA.debugLineNum = 496;BA.debugLine="vibration.vibrateOnce(1500)";
_vibration.vibrateOnce(processBA,(long) (1500));
 //BA.debugLineNum = 497;BA.debugLine="ShowEntryError($\"ERROR\"$, $\"Added By cannot be";
_showentryerror(("ERROR"),("Added By cannot be blank!"));
 //BA.debugLineNum = 498;BA.debugLine="txtTableNo.RequestFocus";
...
if (true) return anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e40); //BA.debugLineNum = 503;BA.debugLine="Return False";
if (true) return anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 504;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("111468848",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };

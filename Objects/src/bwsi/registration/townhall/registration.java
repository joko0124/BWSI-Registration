...
public static int _swapregid = 0;
...
public static String _sswaptableno = "";
...
public anywheresoftware.b4a.objects.LabelWrapper _lblunregcount = null;
...
anywheresoftware.b4a.object.XmlLayoutBuilder _xl = null;
 //BA.debugLineNum = 158;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 160;BA.debugLine="Scale.SetRate(0.5)";
mostCurrent._scale._setrate /*String*/ (mostCurrent.activityBA,0.5);
 //BA.debugLineNum = 161;BA.debugLine="Activity.LoadLayout(\"Registration\")";
mostCurrent._activity.LoadLayout("Registration",mostCurrent.activityBA);
 //BA.debugLineNum = 163;BA.debugLine="GlobalVar.CSTitle.Initialize.Size(17).Bold.Append";
mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (17)).Bold().Append(BA.ObjectToCharSequence(mostCurrent._globalvar._areaname /*String*/ )).PopAll();
 //BA.debugLineNum = 164;BA.debugLine="GlobalVar.CSSubTitle.Initialize.Size(14).Append(G";
mostCurrent._globalvar._cssubtitle /*anywheresoftware.b4a.objects.CSBuilder*/ .Initialize().Size((int) (14)).Append(BA.ObjectToCharSequence(mostCurrent._globalvar._areadesc /*String*/ )).PopAll();
 //BA.debugLineNum = 166;BA.debugLine="ToolBar.InitMenuListener";
mostCurrent._toolbar.InitMenuListener();
 //BA.debugLineNum = 167;BA.debugLine="ToolBar.Title = GlobalVar.CSTitle";
mostCurrent._toolbar.setTitle(BA.ObjectToCharSequence(mostCurrent._globalvar._cstitle /*anywheresoftware.b4a.objects.CSBuilder*/ .getObject()));
 //BA.debugLineNum = 168;BA.debugLine="ToolBar.SubTitle = GlobalVar.CSSubTitle";
...
_jo = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 171;BA.debugLine="Dim xl As XmlLayoutBuilder";
_xl = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 172;BA.debugLine="jo = ToolBar";
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(mostCurrent._toolbar.getObject()));
 //BA.debugLineNum = 173;BA.debugLine="jo.RunMethod(\"setPopupTheme\", Array(xl.GetResourc";
_jo.RunMethod("setPopupTheme",new Object[]{(Object)(_xl.GetResourceId("style","ToolbarMenu"))});
 //BA.debugLineNum = 174;BA.debugLine="jo.RunMethod(\"setContentInsetStartWithNavigation\"";
_jo.RunMethod("setContentInsetStartWithNavigation",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1)))});
 //BA.debugLineNum = 175;BA.debugLine="jo.RunMethod(\"setTitleMarginStart\", Array(0dip))";
_jo.RunMethod("setTitleMarginStart",new Object[]{(Object)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)))});
 //BA.debugLineNum = 177;BA.debugLine="ActionBarButton.Initialize";
mostCurrent._actionbarbutton.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 178;BA.debugLine="ActionBarButton.ShowUpIndicator = True";
mostCurrent._actionbarbutton.setShowUpIndicator(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 180;BA.debugLine="GlobalVar.AreaID = DBFunctions.GetAreaID";
mostCurrent._globalvar._areaid /*int*/  = mostCurrent._dbfunctions._getareaid /*int*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 181;BA.debugLine="GlobalVar.AreaCode = DBFunctions.GetAreaCode(Glob";
mostCurrent._globalvar._areacode /*String*/  = mostCurrent._dbfunctions._getareacode /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 182;BA.debugLine="GlobalVar.AreaName = DBFunctions.GetAreaName(Glob";
mostCurrent._globalvar._areaname /*String*/  = mostCurrent._dbfunctions._getareaname /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 183;BA.debugLine="GlobalVar.AreaDesc = DBFunctions.GetAreaDesc(Glob";
mostCurrent._globalvar._areadesc /*String*/  = mostCurrent._dbfunctions._getareadesc /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 185;BA.debugLine="BTAdmin.Initialize(\"Admin\")";
_btadmin.Initialize(processBA,"Admin");
 //BA.debugLineNum = 186;BA.debugLine="Serial1.Initialize(\"Printer\")";
_serial1.Initialize("Printer");
 //BA.debugLineNum = 189;BA.debugLine="FillEmployees(GlobalVar.AreaID)";
_fillemployees(mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 190;BA.debugLine="CDTxtBox.Initialize2(Colors.Transparent, Colors.T";
mostCurrent._cdtxtbox.Initialize2(anywheresoftware.b4a.keywords.Common.Colors.Transparent,anywheresoftware.b4a.keywords.Common.Colors.Transparent,(int) (0),(int) (0));
 //BA.debugLineNum = 191;BA.debugLine="txtSearch.Background = CDTxtBox";
mostCurrent._txtsearch.setBackground((android.graphics.drawable.Drawable)(mostCurrent._cdtxtbox.getObject()));
 //BA.debugLineNum = 193;BA.debugLine="blnNewReg = True";
_blnnewreg = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 194;BA.debugLine="IMEKeyboard.Initialize(\"\")";
...
public static boolean  _activity_keypress(int _keycode) throws Exception{
 ...
 //BA.debugLineNum = 198;BA.debugLine="If KeyCode = 4 Then";
if (_keycode==4) { 
 //BA.debugLineNum = 199;BA.debugLine="ToolBar_NavigationItemClick";
...
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 206;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 207;BA.debugLine="GlobalVar.AreaID = DBFunctions.GetAreaID";
mostCurrent._globalvar._areaid /*int*/  = mostCurrent._dbfunctions._getareaid /*int*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 208;BA.debugLine="GlobalVar.AreaCode = DBFunctions.GetAreaCode(Glob";
mostCurrent._globalvar._areacode /*String*/  = mostCurrent._dbfunctions._getareacode /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 209;BA.debugLine="GlobalVar.AreaName = DBFunctions.GetAreaName(Glob";
mostCurrent._globalvar._areaname /*String*/  = mostCurrent._dbfunctions._getareaname /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 210;BA.debugLine="GlobalVar.AreaDesc = DBFunctions.GetAreaDesc(Glob";
mostCurrent._globalvar._areadesc /*String*/  = mostCurrent._dbfunctions._getareadesc /*String*/ (mostCurrent.activityBA,mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 211;BA.debugLine="blnNewReg = True";
_blnnewreg = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 213;BA.debugLine="vibratePattern = Array As Long(500, 500, 300, 500";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 849;BA.debugLine="Private Sub AddPeople_OnCancelClicked (View As Vie";
 //BA.debugLineNum = 850;BA.debugLine="If View<>Null Then";
if (_view!= null) { 
 //BA.debugLineNum = 851;BA.debugLine="ToastMessageShow(\"Cancelled!\",False)";
...
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 853;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 835;BA.debugLine="Private Sub AddPeople_OnItemClick (View As View, S";
 //BA.debugLineNum = 837;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 838;BA.debugLine="Alert.Initialize.Dismiss2";
_alert.Initialize().Dismiss2();
 //BA.debugLineNum = 840;BA.debugLine="Select Case Position";
switch (_position) {
case 0: {
 //BA.debugLineNum = 843;BA.debugLine="StartActivity(AddEmployee)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addemployee.getObject()));
 break; }
case 1: {
 //BA.debugLineNum = 845;BA.debugLine="StartActivity(AddGuest)";
...
public static String  _btncancel_click() throws Exception{
 //BA.debugLineNum = 1304;BA.debugLine="Sub btnCancel_Click";
 //BA.debugLineNum = 1305;BA.debugLine="SearchClosed";
_searchclosed();
...
bwsi.registration.townhall.registration._employeeinfo _employees = null;
 //BA.debugLineNum = 427;BA.debugLine="Sub btnRegister_Click";
 //BA.debugLineNum = 428;BA.debugLine="Dim Value As Object";
_value = new Object();
 //BA.debugLineNum = 429;BA.debugLine="Dim Index As Int = clvEmployees.GetItemFromView(S";
_index = mostCurrent._clvemployees._getitemfromview((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA))));
 //BA.debugLineNum = 430;BA.debugLine="Dim Employees As EmployeeInfo = clvEmployees.GetV";
_employees = (bwsi.registration.townhall.registration._employeeinfo)(mostCurrent._clvemployees._getvalue(_index));
 //BA.debugLineNum = 432;BA.debugLine="Value = Employees.RegID";
_value = (Object)(_employees.RegID /*int*/ );
 //BA.debugLineNum = 434;BA.debugLine="Log(Value)";
anywheresoftware.b4a.keywords.Common.LogImpl("17208967",BA.ObjectToString(_value),0);
 //BA.debugLineNum = 437;BA.debugLine="NewRegID = Value";
_newregid = (int)(BA.ObjectToNumber(_value));
 //BA.debugLineNum = 438;BA.debugLine="LogColor($\"Registration ID: \"$ & Value, Colors.Cy";
anywheresoftware.b4a.keywords.Common.LogImpl("17208971",("Registration ID: ")+BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 439;BA.debugLine="Try";
try { //BA.debugLineNum = 440;BA.debugLine="sRegName = GetEmployeeName(Value)";
mostCurrent._sregname = _getemployeename((int)(BA.ObjectToNumber(_value)));
 } 
       catch (Exception e11) {
			processBA.setLastException(e11); //BA.debugLineNum = 442;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("17208975",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 444;BA.debugLine="vibration.vibratePattern(vibratePattern,0)";
_vibration.vibratePattern(processBA,_vibratepattern,(int) (0));
 //BA.debugLineNum = 446;BA.debugLine="ConfirmRegister(sRegName)";
...
bwsi.registration.townhall.registration._employeeinfo _employees = null;
int _btnstatus = 0;
 //BA.debugLineNum = 385;BA.debugLine="Sub btnSwap_Click";
 //BA.debugLineNum = 386;BA.debugLine="Dim Value As Object";
_value = new Object();
 //BA.debugLineNum = 387;BA.debugLine="Dim Index As Int = clvEmployees.GetItemFromView(S";
_index = mostCurrent._clvemployees._getitemfromview((anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(anywheresoftware.b4a.keywords.Common.Sender(mostCurrent.activityBA))));
 //BA.debugLineNum = 388;BA.debugLine="Dim Employees As EmployeeInfo = clvEmployees.GetV";
_employees = (bwsi.registration.townhall.registration._employeeinfo)(mostCurrent._clvemployees._getvalue(_index));
 //BA.debugLineNum = 390;BA.debugLine="Value = Employees.RegID";
_value = (Object)(_employees.RegID /*int*/ );
 //BA.debugLineNum = 391;BA.debugLine="iSwapBranchID = Employees.BranchID";
_iswapbranchid = _employees.BranchID /*int*/ ;
 //BA.debugLineNum = 392;BA.debugLine="Dim btnStatus As Int";
_btnstatus = 0;
 //BA.debugLineNum = 394;BA.debugLine="LogColor(Value, Colors.Red)";
anywheresoftware.b4a.keywords.Common.LogImpl("17143433",BA.ObjectToString(_value),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 397;BA.debugLine="btnStatus = Employees.RegStatus";
_btnstatus = _employees.RegStatus /*int*/ ;
 //BA.debugLineNum = 399;BA.debugLine="LogColor($\"Register Status: \"$ & btnStatus, Color";
anywheresoftware.b4a.keywords.Common.LogImpl("17143438",("Register Status: ")+BA.NumberToString(_btnstatus),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 400;BA.debugLine="LogColor($\"Branch ID: \"$ & iSwapBranchID, Colors.";
anywheresoftware.b4a.keywords.Common.LogImpl("17143439",("Branch ID: ")+BA.NumberToString(_iswapbranchid),anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 402;BA.debugLine="Try";
try { //BA.debugLineNum = 403;BA.debugLine="Select Case btnStatus";
switch (_btnstatus) {
case 0: {
 //BA.debugLineNum = 405;BA.debugLine="If pnlSearchMain.Visible = True Then Return";
if (mostCurrent._pnlsearchmain.getVisible()==anywheresoftware.b4a.keywords.Common.True) { 
if (true) return "";};
 //BA.debugLineNum = 406;BA.debugLine="pnlSearchMain.Visible = True";
mostCurrent._pnlsearchmain.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 407;BA.debugLine="lblSearchTitle.Text = $\"Search Employee to Swa";
mostCurrent._lblsearchtitle.setText(BA.ObjectToCharSequence(("Search Employee to Swap Duty")));
 //BA.debugLineNum = 408;BA.debugLine="SV.Initialize(Me,\"SV\")";
mostCurrent._sv._initialize /*String*/ (mostCurrent.activityBA,registration.getObject(),"SV");
 //BA.debugLineNum = 409;BA.debugLine="SV.AddToParent(pnlSearchEmployees, 3, 3, pnlSe";
mostCurrent._sv._addtoparent /*String*/ (mostCurrent._pnlsearchemployees,(int) (3),(int) (3),(int) (mostCurrent._pnlsearchemployees.getWidth()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),mostCurrent._pnlsearchemployees.getHeight());
 //BA.debugLineNum = 410;BA.debugLine="SV.ClearAll";
mostCurrent._sv._clearall /*String*/ ();
 //BA.debugLineNum = 411;BA.debugLine="SV.lv.Clear";
mostCurrent._sv._lv /*anywheresoftware.b4a.objects.ListViewWrapper*/ .Clear();
 //BA.debugLineNum = 412;BA.debugLine="btnCancel.Enabled = True";
mostCurrent._btncancel.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 413;BA.debugLine="SwapRegID = Value";
_swapregid = (int)(BA.ObjectToNumber(_value));
 //BA.debugLineNum = 414;BA.debugLine="SearchSwapEmployees(iSwapBranchID)";
_searchswapemployees(_iswapbranchid);
 break; }
case 1: {
 //BA.debugLineNum = 417;BA.debugLine="sRegName = GetEmployeeName(Value)";
mostCurrent._sregname = _getemployeename((int)(BA.ObjectToNumber(_value)));
 //BA.debugLineNum = 418;BA.debugLine="NewRegID = Value";
_newregid = (int)(BA.ObjectToNumber(_value));
 //BA.debugLineNum = 419;BA.debugLine="ConfirmReprint(sRegName)";
...
;
			...
			processBA.setLastException(e30); //BA.debugLineNum = 422;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("17143461",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 425;BA.debugLine="End Sub";
return "";
}
public static String  _clvemployees_itemclick(int _index,Object _value) throws Exception{
 //BA.debugLineNum = 381;BA.debugLine="Sub clvEmployees_ItemClick (Index As Int, Value As";
...
bwsi.registration.townhall.registration._employeeinfo _ei = null;
 //BA.debugLineNum = 322;BA.debugLine="Sub clvEmployees_VisibleRangeChanged (FirstIndex A";
 //BA.debugLineNum = 323;BA.debugLine="Dim ExtraSize As Int = 15 'List size";
_extrasize = (int) (15);
 //BA.debugLineNum = 324;BA.debugLine="clvEmployees.Refresh";
mostCurrent._clvemployees._refresh();
 //BA.debugLineNum = 326;BA.debugLine="For i = Max(0, FirstIndex - ExtraSize) To Min(Las";
{
final int step3 = 1;
...
for (;_i <= limit3 ;_i = _i + step3 ) {
 //BA.debugLineNum = 327;BA.debugLine="Dim Pnl As B4XView = clvEmployees.GetPanel(i)";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = mostCurrent._clvemployees._getpanel(_i);
 //BA.debugLineNum = 328;BA.debugLine="If i > FirstIndex - ExtraSize And i < LastIndex";
if (_i>_firstindex-_extrasize && _i<_lastindex+_extrasize) { 
 //BA.debugLineNum = 329;BA.debugLine="If Pnl.NumberOfViews = 0 Then 'Add each item/la";
if (_pnl.getNumberOfViews()==0) { 
 //BA.debugLineNum = 330;BA.debugLine="Dim EI As EmployeeInfo = clvEmployees.GetValue";
_ei = (bwsi.registration.townhall.registration._employeeinfo)(mostCurrent._clvemployees._getvalue(_i));
 //BA.debugLineNum = 331;BA.debugLine="Pnl.LoadLayout(\"EmployeeList\")";
_pnl.LoadLayout("EmployeeList",mostCurrent.activityBA);
 //BA.debugLineNum = 333;BA.debugLine="lblBranch.Text = EI.BranchName";
mostCurrent._lblbranch.setText(BA.ObjectToCharSequence(_ei.BranchName /*String*/ ));
 //BA.debugLineNum = 334;BA.debugLine="lblAvatar.Text = EI.Avatar";
mostCurrent._lblavatar.setText(BA.ObjectToCharSequence(_ei.Avatar /*String*/ ));
 //BA.debugLineNum = 335;BA.debugLine="lblEmpName.Text = EI.EmpName";
mostCurrent._lblempname.setText(BA.ObjectToCharSequence(_ei.EmpName /*String*/ ));
 //BA.debugLineNum = 336;BA.debugLine="lblDivision.Text = EI.EmpDivision";
mostCurrent._lbldivision.setText(BA.ObjectToCharSequence(_ei.EmpDivision /*String*/ ));
 //BA.debugLineNum = 337;BA.debugLine="SetButtonColors";
_setbuttoncolors();
 //BA.debugLineNum = 339;BA.debugLine="AvatarBG.Color = ShadeColor(Rnd(0xFF59C6CC, 0x";
mostCurrent._avatarbg.setColor(_shadecolor(anywheresoftware.b4a.keywords.Common.Rnd((int) (0xff59c6cc),(int) (0xfff8d0cd))));
 //BA.debugLineNum = 341;BA.debugLine="If EI.WillAttend = 1 Then";
if (_ei.WillAttend /*int*/ ==1) { 
 //BA.debugLineNum = 342;BA.debugLine="If EI.RegStatus = 0 Then";
if (_ei.RegStatus /*int*/ ==0) { 
 //BA.debugLineNum = 343;BA.debugLine="lblStatus.Text = \"UNREGISTERED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("UNREGISTERED"));
 //BA.debugLineNum = 344;BA.debugLine="lblStatus.TextColor = GlobalVar.NegColor";
mostCurrent._lblstatus.setTextColor((int) (mostCurrent._globalvar._negcolor /*double*/ ));
 //BA.debugLineNum = 345;BA.debugLine="btnRegister.Enabled = True";
mostCurrent._btnregister.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 346;BA.debugLine="btnSwap.Enabled = False";
mostCurrent._btnswap.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 347;BA.debugLine="btnSwap.Text = \"PRINT STUB\"";
mostCurrent._btnswap.setText(BA.ObjectToCharSequence("PRINT STUB"));
 }else {
 //BA.debugLineNum = 349;BA.debugLine="lblStatus.Text = \"REGISTERED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("REGISTERED"));
 //BA.debugLineNum = 350;BA.debugLine="lblStatus.TextColor = GlobalVar.PriColor";
mostCurrent._lblstatus.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 351;BA.debugLine="btnRegister.Enabled = False";
mostCurrent._btnregister.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 352;BA.debugLine="btnSwap.Enabled = True";
mostCurrent._btnswap.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 353;BA.debugLine="btnSwap.Text = \"REPRINT STUB\"";
mostCurrent._btnswap.setText(BA.ObjectToCharSequence("REPRINT STUB"));
 };
 }else {
 //BA.debugLineNum = 356;BA.debugLine="If EI.RegStatus = 0 Then";
if (_ei.RegStatus /*int*/ ==0) { 
 //BA.debugLineNum = 357;BA.debugLine="lblStatus.Text = \"UNREGISTERED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("UNREGISTERED"));
 //BA.debugLineNum = 358;BA.debugLine="lblStatus.TextColor = GlobalVar.NegColor";
mostCurrent._lblstatus.setTextColor((int) (mostCurrent._globalvar._negcolor /*double*/ ));
 //BA.debugLineNum = 359;BA.debugLine="btnRegister.Enabled = True";
mostCurrent._btnregister.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 360;BA.debugLine="btnSwap.Enabled = True";
mostCurrent._btnswap.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 361;BA.debugLine="btnSwap.Text = \"SWAP DUTY\"";
mostCurrent._btnswap.setText(BA.ObjectToCharSequence("SWAP DUTY"));
 }else {
 //BA.debugLineNum = 363;BA.debugLine="lblStatus.Text = \"REGISTERED\"";
mostCurrent._lblstatus.setText(BA.ObjectToCharSequence("REGISTERED"));
 //BA.debugLineNum = 364;BA.debugLine="lblStatus.TextColor = GlobalVar.PriColor";
mostCurrent._lblstatus.setTextColor((int) (mostCurrent._globalvar._pricolor /*double*/ ));
 //BA.debugLineNum = 365;BA.debugLine="btnRegister.Enabled = False";
mostCurrent._btnregister.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 366;BA.debugLine="btnSwap.Enabled = True";
mostCurrent._btnswap.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 367;BA.debugLine="btnSwap.Text = \"REPRINT STUB\"";
mostCurrent._btnswap.setText(BA.ObjectToCharSequence("REPRINT STUB"));
 };
 };
 };
 }else {
 //BA.debugLineNum = 373;BA.debugLine="If Pnl.NumberOfViews > 0 Then";
if (_pnl.getNumberOfViews()>0) { 
 //BA.debugLineNum = 374;BA.debugLine="Pnl.RemoveAllViews 'Remove none visable item/l";
_pnl.RemoveAllViews();
 };
 };
 }
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 560;BA.debugLine="Private Sub ConfirmRegister (sEmpName As String)";
 //BA.debugLineNum = 561;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 563;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(("CONFIRM REGISTRATION")).SetMessage(("Do you want to Register")+anywheresoftware.b4a.keywords.Common.CRLF+_sempname+("?")).SetPositiveText("YES").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetNegativeText("NO").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"RegisterEmp").SetOnNegativeClicked(mostCurrent.activityBA,"RegisterEmp").SetOnViewBinder(mostCurrent.activityBA,"RegFontSizeBinder");
 //BA.debugLineNum = 581;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 582;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 606;BA.debugLine="Private Sub ConfirmReprint (sEmpName As String)";
 //BA.debugLineNum = 607;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 609;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(("CONFIRM REPRINT STUB")).SetMessage(("Do you want to Reprint")+anywheresoftware.b4a.keywords.Common.CRLF+_sempname+(" stub?")).SetPositiveText("YES").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetNegativeText("NO").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"StubReprint").SetOnNegativeClicked(mostCurrent.activityBA,"StubReprint").SetOnViewBinder(mostCurrent.activityBA,"RegFontSizeBinder");
 //BA.debugLineNum = 627;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 628;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 650;BA.debugLine="Private Sub ConfirmSwapEmp (sEmpName As String)";
 //BA.debugLineNum = 651;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 653;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(("CONFIRM SWAP DUTY")).SetMessage(("Confirm Swap Duty with")+anywheresoftware.b4a.keywords.Common.CRLF+_sempname+("?")).SetPositiveText("YES").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetNegativeText("NO").SetNegativeColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"SwapEmp").SetOnNegativeClicked(mostCurrent.activityBA,"SwapEmp").SetOnViewBinder(mostCurrent.activityBA,"RegFontSizeBinder");
 //BA.debugLineNum = 671;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
...
public static String  _countunregistered(int _iareaid) throws Exception{
int _iretval = 0;
 //BA.debugLineNum = 297;BA.debugLine="Private Sub CountUnregistered(iAreaID As Int)";
 //BA.debugLineNum = 298;BA.debugLine="Dim iRetVal As Int";
_iretval = 0;
 //BA.debugLineNum = 300;BA.debugLine="iRetVal = 0";
_iretval = (int) (0);
 //BA.debugLineNum = 301;BA.debugLine="Try";
try { //BA.debugLineNum = 302;BA.debugLine="Starter.strCriteria = \"SELECT Count(Employees.Re";
mostCurrent._starter._strcriteria /*String*/  = "SELECT Count(Employees.RegID) FROM tblRegistration AS Employees "+"INNER JOIN tblBranches AS Branches ON Employees.BranchID = Branches.BranchID "+"WHERE Employees.WasRegistered = 0 "+"AND Employees.WillAttend <> 0 "+"AND Branches.AreaID = "+BA.NumberToString(_iareaid);
 //BA.debugLineNum = 307;BA.debugLine="LogColor(Starter.strCriteria, Colors.Blue)";
anywheresoftware.b4a.keywords.Common.LogImpl("16946826",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Blue);
 //BA.debugLineNum = 309;BA.debugLine="iRetVal = Starter.DBCon.ExecQuerySingleResult(St";
_iretval = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult(mostCurrent._starter._strcriteria /*String*/ )));
			...
			processBA.setLastException(e8); //BA.debugLineNum = 312;BA.debugLine="iRetVal = 0";
_iretval = (int) (0);
 //BA.debugLineNum = 313;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("16946832",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 315;BA.debugLine="If iRetVal = 0 Then";
if (_iretval==0) { 
 //BA.debugLineNum = 316;BA.debugLine="lblUnregCount.Text = $\"TOTAL UNREGISTERED: 0\"$";
mostCurrent._lblunregcount.setText(BA.ObjectToCharSequence(("TOTAL UNREGISTERED: 0")));
 }else {
 //BA.debugLineNum = 318;BA.debugLine="lblUnregCount.Text = $\"TOTAL UNREGISTERED: \"$ &";
mostCurrent._lblunregcount.setText(BA.ObjectToCharSequence(("TOTAL UNREGISTERED: ")+BA.NumberToString(_iretval)));
 };
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _drwpressedcolor = null;
 //BA.debugLineNum = 469;BA.debugLine="Private Sub CreateButtonColor(FocusedColor As Int,";
 //BA.debugLineNum = 471;BA.debugLine="Dim RetColor As StateListDrawable";
_retcolor = new anywheresoftware.b4a.objects.drawable.StateListDrawable();
 //BA.debugLineNum = 472;BA.debugLine="RetColor.Initialize";
_retcolor.Initialize();
 //BA.debugLineNum = 473;BA.debugLine="Dim drwFocusedColor, drwEnabledColor, drwDisabled";
...
anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _b = null;
 //BA.debugLineNum = 1065;BA.debugLine="Sub CreateScaledBitmap(Original As Bitmap, NewWidt";
 //BA.debugLineNum = 1066;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 1067;BA.debugLine="Dim b As Bitmap";
_b = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 1068;BA.debugLine="b = r.RunStaticMethod(\"android.graphics.Bitmap\",";
_b = (anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(_r.RunStaticMethod("android.graphics.Bitmap","createScaledBitmap",new Object[]{(Object)(_original.getObject()),(Object)(_newwidth),(Object)(_newheight),(Object)(anywheresoftware.b4a.keywords.Common.True)},new String[]{"android.graphics.Bitmap","java.lang.int","java.lang.int","java.lang.boolean"})));
 //BA.debugLineNum = 1069;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 1070;BA.debugLine="End Sub";
return null;
}
public static void  _fillemployees(int _iareaid) throws Exception{
ResumableSub_FillEmployees rsub = new ResumableSub_FillEmployees(null,_iareaid);
rsub.resume(processBA, null);
}
public static class ResumableSub_FillEmployees extends BA.ResumableSub {
public ResumableSub_FillEmployees(bwsi.registration.townhall.registration parent,int _iareaid) {
this.parent = parent;
...
//C
this.state = 1;
 //BA.debugLineNum = 239;BA.debugLine="Dim SenderFilter As Object";
...
this.state = 4;
this.catchState = 22;
 //BA.debugLineNum = 242;BA.debugLine="Starter.strCriteria = \"SELECT Employees.BranchID";
...
anywheresoftware.b4a.keywords.Common.LogImpl("16881296",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
...
;
 //BA.debugLineNum = 258;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 7;
 //BA.debugLineNum = 259;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 260;BA.debugLine="clvEmployees.Clear";
...
//C
this.state = 7;
 //BA.debugLineNum = 262;BA.debugLine="Dim EmpInfo As EmployeeInfo";
_empinfo = new bwsi.registration.townhall.registration._employeeinfo();
 //BA.debugLineNum = 263;BA.debugLine="EmpInfo.Initialize";
_empinfo.Initialize();
 //BA.debugLineNum = 264;BA.debugLine="EmpInfo.RegID = RS.GetInt(\"RegID\")";
_empinfo.RegID /*int*/  = _rs.GetInt("RegID");
 //BA.debugLineNum = 265;BA.debugLine="EmpInfo.RegNo = RS.GetString(\"RegNo\")";
_empinfo.RegNo /*String*/  = _rs.GetString("RegNo");
 //BA.debugLineNum = 266;BA.debugLine="EmpInfo.BranchID = RS.GetInt(\"BranchID\")";
_empinfo.BranchID /*int*/  = _rs.GetInt("BranchID");
 //BA.debugLineNum = 267;BA.debugLine="EmpInfo.BranchName = RS.GetString(\"BranchName\"";
_empinfo.BranchName /*String*/  = _rs.GetString("BranchName");
 //BA.debugLineNum = 268;BA.debugLine="EmpInfo.EmpName = RS.GetString(\"FullName\")";
_empinfo.EmpName /*String*/  = _rs.GetString("FullName");
 //BA.debugLineNum = 269;BA.debugLine="EmpInfo.EmpDivision = RS.GetString(\"DivisionNa";
_empinfo.EmpDivision /*String*/  = _rs.GetString("DivisionName");
 //BA.debugLineNum = 270;BA.debugLine="EmpInfo.Avatar = GlobalVar.SF.Upper(GlobalVar.";
_empinfo.Avatar /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv6(_rs.GetString("FirstName"),(long) (1)))+parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv6(_rs.GetString("LastName"),(long) (1)));
 //BA.debugLineNum = 271;BA.debugLine="EmpInfo.WillAttend = RS.GetInt(\"WillAttend\")";
_empinfo.WillAttend /*int*/  = _rs.GetInt("WillAttend");
 //BA.debugLineNum = 272;BA.debugLine="EmpInfo.RegStatus = RS.GetInt(\"WasRegistered\")";
...
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 275;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvEmployee";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvemployees._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (170)));
 //BA.debugLineNum = 276;BA.debugLine="clvEmployees.Add(Pnl, EmpInfo)";
parent.mostCurrent._clvemployees._add(_pnl,(Object)(_empinfo));
 if (true) break;
;
 //BA.debugLineNum = 278;BA.debugLine="If RS.RowCount <= 0 Then";
...
//C
this.state = 17;
 //BA.debugLineNum = 279;BA.debugLine="lblRecCount.Text = $\"No Employee Found\"$";
...
//C
this.state = 17;
 //BA.debugLineNum = 281;BA.debugLine="lblRecCount.Text = RS.RowCount & $\" Employee F";
...
//C
this.state = 17;
 //BA.debugLineNum = 283;BA.debugLine="lblRecCount.Text = RS.RowCount & $\" Employees";
...
this.state = 20;
;
 //BA.debugLineNum = 285;BA.debugLine="CountUnregistered(iAreaID)";
_countunregistered(_iareaid);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("16881329",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("16881334",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
if (true) break;
...
int[] _rets = null;
 //BA.debugLineNum = 455;BA.debugLine="Sub GetARGB(Color As Int) As Int()";
 //BA.debugLineNum = 456;BA.debugLine="Private Rets(4) As Int";
_rets = new int[(int) (4)];
;
 //BA.debugLineNum = 457;BA.debugLine="Rets(0) = Bit.UnsignedShiftRight(Bit.And(Color, 0";
_rets[(int) (0)] = anywheresoftware.b4a.keywords.Common.Bit.UnsignedShiftRight(anywheresoftware.b4a.keywords.Common.Bit.And(_color,(int) (0xff000000)),(int) (24));
 //BA.debugLineNum = 458;BA.debugLine="Rets(1) = Bit.UnsignedShiftRight(Bit.And(Color, 0";
_rets[(int) (1)] = anywheresoftware.b4a.keywords.Common.Bit.UnsignedShiftRight(anywheresoftware.b4a.keywords.Common.Bit.And(_color,(int) (0xff0000)),(int) (16));
 //BA.debugLineNum = 459;BA.debugLine="Rets(2) = Bit.UnsignedShiftRight(Bit.And(Color, 0";
_rets[(int) (2)] = anywheresoftware.b4a.keywords.Common.Bit.UnsignedShiftRight(anywheresoftware.b4a.keywords.Common.Bit.And(_color,(int) (0xff00)),(int) (8));
 //BA.debugLineNum = 460;BA.debugLine="Rets(3) = Bit.And(Color, 0xff)";
_rets[(int) (3)] = anywheresoftware.b4a.keywords.Common.Bit.And(_color,(int) (0xff));
 //BA.debugLineNum = 461;BA.debugLine="Return Rets";
...
String _sretval = "";
 //BA.debugLineNum = 1074;BA.debugLine="Private Sub GetEmployeeName(iEmpID As Int) As Stri";
 //BA.debugLineNum = 1075;BA.debugLine="Dim sRetVal As String";
_sretval = "";
 //BA.debugLineNum = 1076;BA.debugLine="Try";
try { //BA.debugLineNum = 1077;BA.debugLine="sRetVal = Starter.DBCon.ExecQuerySingleResult(\"S";
_sretval = mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT FullName FROM tblRegistration WHERE RegID = "+BA.NumberToString(_iempid));
			...
			processBA.setLastException(e5); //BA.debugLineNum = 1079;BA.debugLine="sRetVal = \"\"";
_sretval = "";
 //BA.debugLineNum = 1080;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19109510",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1082;BA.debugLine="Return sRetVal";
...
int _iretval = 0;
 //BA.debugLineNum = 1156;BA.debugLine="Private Sub GetNoOfStubPrint(iRegID As Int) As Int";
 //BA.debugLineNum = 1157;BA.debugLine="Dim iRetVal As Int";
_iretval = 0;
 //BA.debugLineNum = 1158;BA.debugLine="Try";
try { //BA.debugLineNum = 1159;BA.debugLine="iRetVal = Starter.DBCon.ExecQuerySingleResult(\"S";
_iretval = (int)(Double.parseDouble(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT NoPrintStub FROM tblRegistration WHERE RegID = "+BA.NumberToString(_iregid))));
			...
			processBA.setLastException(e5); //BA.debugLineNum = 1161;BA.debugLine="iRetVal = 0";
_iretval = (int) (0);
 //BA.debugLineNum = 1162;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19306118",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1164;BA.debugLine="Return iRetVal";
...
anywheresoftware.b4a.sql.SQL.CursorWrapper _rsstatus = null;
 //BA.debugLineNum = 1167;BA.debugLine="Private Sub GetRegStatus(iRegID As Int) As Int";
 //BA.debugLineNum = 1168;BA.debugLine="Dim iRetVal As Int";
_iretval = 0;
 //BA.debugLineNum = 1169;BA.debugLine="Dim rsStatus As Cursor";
_rsstatus = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 1170;BA.debugLine="Try";
try { //BA.debugLineNum = 1171;BA.debugLine="Starter.strCriteria = \"SELECT * FROM tblRegistra";
mostCurrent._starter._strcriteria /*String*/  = "SELECT * FROM tblRegistration WHERE RegID = "+BA.NumberToString(_iregid);
 //BA.debugLineNum = 1172;BA.debugLine="rsStatus = Starter.DBCon.ExecQuery(Starter.strCr";
_rsstatus = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 1173;BA.debugLine="If rsStatus.RowCount > 0 Then";
if (_rsstatus.getRowCount()>0) { 
 //BA.debugLineNum = 1174;BA.debugLine="rsStatus.Position = 0";
_rsstatus.setPosition((int) (0));
 //BA.debugLineNum = 1175;BA.debugLine="If rsStatus.GetInt(\"WasRegistered\") = 1 Then 'R";
if (_rsstatus.GetInt("WasRegistered")==1) { 
 //BA.debugLineNum = 1176;BA.debugLine="iRetVal = 1 'Reprint Stub";
_iretval = (int) (1);
 }else {
 //BA.debugLineNum = 1178;BA.debugLine="iRetVal = 2 'Do Nothing";
_iretval = (int) (2);
 };
 };
 } 
       catch (Exception e15) {
			processBA.setLastException(e15); //BA.debugLineNum = 1182;BA.debugLine="iRetVal = 0";
_iretval = (int) (0);
 //BA.debugLineNum = 1183;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19371664",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1185;BA.debugLine="rsStatus.Close";
_rsstatus.Close();
 //BA.debugLineNum = 1186;BA.debugLine="Return iRetVal";
if (true) return _iretval;
...
String _sretval = "";
 //BA.debugLineNum = 1234;BA.debugLine="Private Sub GetSwapEmployeeName(iEmpID As Int) As";
 //BA.debugLineNum = 1235;BA.debugLine="Dim sRetVal As String";
_sretval = "";
 //BA.debugLineNum = 1236;BA.debugLine="Try";
try { //BA.debugLineNum = 1237;BA.debugLine="sRetVal = Starter.DBCon.ExecQuerySingleResult(\"S";
_sretval = mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT FullName FROM tblRegistration WHERE RegID = "+BA.NumberToString(_iempid));
 } 
       catch (Exception e5) {
			processBA.setLastException(e5); //BA.debugLineNum = 1239;BA.debugLine="sRetVal = \"\"";
_sretval = "";
 //BA.debugLineNum = 1240;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19502726",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1242;BA.debugLine="Return sRetVal";
if (true) return _sretval;
 //BA.debugLineNum = 1243;BA.debugLine="End Sub";
return "";
}
public static String  _getswaptableno(int _iempid) throws Exception{
String _sretval = "";
 //BA.debugLineNum = 1245;BA.debugLine="Private Sub GetSwapTableNo(iEmpID As Int) As Strin";
 //BA.debugLineNum = 1246;BA.debugLine="Dim sRetVal As String";
_sretval = "";
 //BA.debugLineNum = 1247;BA.debugLine="Try";
try { //BA.debugLineNum = 1248;BA.debugLine="sRetVal = Starter.DBCon.ExecQuerySingleResult(\"S";
_sretval = mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuerySingleResult("SELECT TableNo FROM tblRegistration WHERE RegID = "+BA.NumberToString(_iempid));
 } 
       catch (Exception e5) {
			processBA.setLastException(e5); //BA.debugLineNum = 1250;BA.debugLine="sRetVal = \"\"";
_sretval = "";
 //BA.debugLineNum = 1251;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("141943046",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1253;BA.debugLine="Return sRetVal";
if (true) return _sretval;
...
mostCurrent._xmlicon = new anywheresoftware.b4a.object.XmlLayoutBuilder();
 //BA.debugLineNum = 64;BA.debugLine="Private rsBranch As Cursor";
mostCurrent._rsbranch = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 65;BA.debugLine="Private rsEmployees As Cursor";
mostCurrent._rsemployees = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 67;BA.debugLine="Type EmployeeInfo (RegID As Int, RegNo As String,";
;
 //BA.debugLineNum = 68;BA.debugLine="Private clvEmployees As CustomListView";
mostCurrent._clvemployees = new b4a.example3.customlistview();
 //BA.debugLineNum = 70;BA.debugLine="Private txtSearch As EditText";
mostCurrent._txtsearch = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 72;BA.debugLine="Private NewRegID, SwapRegID As Int";
_newregid = 0;
_swapregid = 0;
 //BA.debugLineNum = 73;BA.debugLine="Private sRegName As String";
mostCurrent._sregname = "";
 //BA.debugLineNum = 74;BA.debugLine="Private MyList As List";
mostCurrent._mylist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 78;BA.debugLine="Private TitleHeight As Int = 30dip";
_titleheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30));
 //BA.debugLineNum = 79;BA.debugLine="Private DividerHeight As Int = 5dip";
_dividerheight = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5));
 //BA.debugLineNum = 81;BA.debugLine="Private CDTxtBox As ColorDrawable";
mostCurrent._cdtxtbox = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 83;BA.debugLine="Private blnNewReg As Boolean";
_blnnewreg = false;
 //BA.debugLineNum = 85;BA.debugLine="Private btnCancel As ACButton";
mostCurrent._btncancel = new de.amberhome.objects.appcompat.ACButtonWrapper();
 //BA.debugLineNum = 86;BA.debugLine="Private lblSearchTitle As Label";
mostCurrent._lblsearchtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 87;BA.debugLine="Private pnlSearchEmployees As Panel";
mostCurrent._pnlsearchemployees = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 88;BA.debugLine="Private pnlSearchMain As Panel";
mostCurrent._pnlsearchmain = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 89;BA.debugLine="Dim iSwapBranchID As Int";
_iswapbranchid = 0;
 //BA.debugLineNum = 90;BA.debugLine="Dim iSwapEmpID As Int";
_iswapempid = 0;
 //BA.debugLineNum = 91;BA.debugLine="Dim sSwapEmp As String";
mostCurrent._sswapemp = "";
 //BA.debugLineNum = 92;BA.debugLine="Dim sSwapTableNo As String";
mostCurrent._sswaptableno = "";
 //BA.debugLineNum = 94;BA.debugLine="Private SV As SearchView";
mostCurrent._sv = new bwsi.registration.townhall.searchview();
 //BA.debugLineNum = 96;BA.debugLine="Private AvatarBG As Panel";
mostCurrent._avatarbg = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 97;BA.debugLine="Private lblAvatar As Label";
mostCurrent._lblavatar = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 98;BA.debugLine="Private lblBranch As Label";
mostCurrent._lblbranch = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 99;BA.debugLine="Private lblDivision As Label";
mostCurrent._lbldivision = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 100;BA.debugLine="Private lblEmpName As Label";
mostCurrent._lblempname = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 101;BA.debugLine="Private lblStatus As Label";
mostCurrent._lblstatus = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 103;BA.debugLine="Private btnRegister As ACButton";
mostCurrent._btnregister = new de.amberhome.objects.appcompat.ACButtonWrapper();
 //BA.debugLineNum = 104;BA.debugLine="Private btnSwap As ACButton";
mostCurrent._btnswap = new de.amberhome.objects.appcompat.ACButtonWrapper();
 //BA.debugLineNum = 106;BA.debugLine="Private lblRecCount As Label";
mostCurrent._lblreccount = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 107;BA.debugLine="Private IMEKeyboard As IME";
mostCurrent._imekeyboard = new anywheresoftware.b4a.objects.IME();
 //BA.debugLineNum = 110;BA.debugLine="Dim ESC As String = Chr(27)";
mostCurrent._esc = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (27)));
 //BA.debugLineNum = 111;BA.debugLine="Dim FS As String = Chr(28)";
mostCurrent._fs = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (28)));
 //BA.debugLineNum = 112;BA.debugLine="Dim GS As String = Chr(29)";
mostCurrent._gs = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (29)));
 //BA.debugLineNum = 115;BA.debugLine="Dim UNREVERSE As String  = GS & \"B\" & Chr(0)";
mostCurrent._unreverse = mostCurrent._gs+"B"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0)));
 //BA.debugLineNum = 116;BA.debugLine="Dim REVERSE As String = GS & \"B\" & Chr(1)";
mostCurrent._reverse = mostCurrent._gs+"B"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (1)));
 //BA.debugLineNum = 119;BA.debugLine="Dim UNINVERT As String = ESC & \"{0\"";
mostCurrent._uninvert = mostCurrent._esc+"{0";
 //BA.debugLineNum = 120;BA.debugLine="Dim INVERT As String = ESC & \"{1\"";
mostCurrent._invert = mostCurrent._esc+"{1";
 //BA.debugLineNum = 123;BA.debugLine="Dim UNROTATE As String = ESC & \"V0\"";
mostCurrent._unrotate = mostCurrent._esc+"V0";
 //BA.debugLineNum = 124;BA.debugLine="Dim ROTATE As String = ESC & \"V1\"";
mostCurrent._rotate = mostCurrent._esc+"V1";
 //BA.debugLineNum = 127;BA.debugLine="Dim HT As String = Chr(9)";
mostCurrent._ht = BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (9)));
 //BA.debugLineNum = 130;BA.debugLine="Dim ULINE0 As String = ESC & \"-0\"";
mostCurrent._uline0 = mostCurrent._esc+"-0";
 //BA.debugLineNum = 131;BA.debugLine="Dim ULINE1 As String = ESC & \"-1\"";
mostCurrent._uline1 = mostCurrent._esc+"-1";
 //BA.debugLineNum = 132;BA.debugLine="Dim ULINE2 As String = ESC & \"-2\"";
mostCurrent._uline2 = mostCurrent._esc+"-2";
 //BA.debugLineNum = 135;BA.debugLine="Dim BOLD As String = ESC & \"E1\"";
mostCurrent._bold = mostCurrent._esc+"E1";
 //BA.debugLineNum = 136;BA.debugLine="Dim NOBOLD As String = ESC & \"E0\"";
mostCurrent._nobold = mostCurrent._esc+"E0";
 //BA.debugLineNum = 139;BA.debugLine="Dim SINGLE As String = GS & \"!\" & Chr(0x00)";
mostCurrent._single = mostCurrent._gs+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x00)));
 //BA.debugLineNum = 140;BA.debugLine="Dim HIGH As String = GS & \"!\" & Chr(0x01)";
mostCurrent._high = mostCurrent._gs+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x01)));
 //BA.debugLineNum = 141;BA.debugLine="Dim WIDE As String = GS & \"!\" & Chr(0x10)";
mostCurrent._wide = mostCurrent._gs+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x10)));
 //BA.debugLineNum = 142;BA.debugLine="Dim HIGHWIDE As String = GS & \"!\" & Chr(0x11)";
mostCurrent._highwide = mostCurrent._gs+"!"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x11)));
 //BA.debugLineNum = 145;BA.debugLine="Private LEFTJUSTIFY As String = ESC & \"a0\"";
mostCurrent._leftjustify = mostCurrent._esc+"a0";
 //BA.debugLineNum = 146;BA.debugLine="Private LINEDEFAULT As String = ESC & \"2\"";
mostCurrent._linedefault = mostCurrent._esc+"2";
 //BA.debugLineNum = 147;BA.debugLine="Private LINSET0 As String = ESC & \"$\" & Chr(0x0)";
mostCurrent._linset0 = mostCurrent._esc+"$"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)));
 //BA.debugLineNum = 148;BA.debugLine="Private LMARGIN0 As String = GS & \"L\" & Chr(0x0)";
mostCurrent._lmargin0 = mostCurrent._gs+"L"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0x0)));
 //BA.debugLineNum = 149;BA.debugLine="Private WIDTH0 As String = GS & \"W\" & Chr(0xff) &";
mostCurrent._width0 = mostCurrent._gs+"W"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xff)))+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xff)));
 //BA.debugLineNum = 150;BA.debugLine="Private CHARSPACING0 As String = ESC & \" \" & Chr(";
mostCurrent._charspacing0 = mostCurrent._esc+" "+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0)));
 //BA.debugLineNum = 151;BA.debugLine="Private CHARFONT0 As String = ESC & \"M\" & Chr(0)";
mostCurrent._charfont0 = mostCurrent._esc+"M"+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0)));
 //BA.debugLineNum = 152;BA.debugLine="Dim DEFAULTS As String =  CHARSPACING0 & CHARFONT";
mostCurrent._defaults = mostCurrent._charspacing0+mostCurrent._charfont0+mostCurrent._lmargin0+mostCurrent._width0+mostCurrent._linset0+mostCurrent._linedefault+mostCurrent._leftjustify+mostCurrent._uninvert+mostCurrent._unrotate+mostCurrent._unreverse+mostCurrent._nobold+mostCurrent._uline0;
 //BA.debugLineNum = 155;BA.debugLine="Private lblUnregCount As Label";
mostCurrent._lblunregcount = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 156;BA.debugLine="End Sub";
return "";
}
public static String  _pnlsearchmain_touch(int _action,float _x,float _y) throws Exception{
 //BA.debugLineNum = 1300;BA.debugLine="Sub pnlSearchMain_Touch (Action As Int, X As Float";
...
//C
this.state = 1;
 //BA.debugLineNum = 1018;BA.debugLine="Log(\"Connected: \" & Success)";
anywheresoftware.b4a.keywords.Common.LogImpl("18978433","Connected: "+BA.ObjectToString(_success),0);
 //BA.debugLineNum = 1020;BA.debugLine="If Success = False Then";
if (true) break;
...
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 1025;BA.debugLine="StartPrinter";
_startprinter();
 if (true) break;
...
//C
this.state = 6;
 //BA.debugLineNum = 1028;BA.debugLine="Dim initPrinter() As Byte";
_initprinter = new byte[(int) (0)];
;
 //BA.debugLineNum = 1030;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 1031;BA.debugLine="TMPrinter.Initialize2(Serial1.OutputStream, \"win";
parent._tmprinter.Initialize2(parent._serial1.getOutputStream(),"windows-1252");
 //BA.debugLineNum = 1032;BA.debugLine="oStream.Initialize(Serial1.InputStream, Serial1.";
parent._ostream.Initialize(processBA,parent._serial1.getInputStream(),parent._serial1.getOutputStream(),"LogoPrint");
 //BA.debugLineNum = 1033;BA.debugLine="Logo.Initialize(File.DirAssets, \"Stub-Header-Tow";
parent._logo.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Stub-Header-Townhall.png");
 //BA.debugLineNum = 1034;BA.debugLine="LogoBMP = CreateScaledBitmap(Logo, Logo.Width, L";
parent._logobmp = _createscaledbitmap(parent._logo,parent._logo.getWidth(),parent._logo.getHeight());
 //BA.debugLineNum = 1035;BA.debugLine="Log(DeviceName)";
anywheresoftware.b4a.keywords.Common.LogImpl("18978450",parent._devicename,0);
 //BA.debugLineNum = 1037;BA.debugLine="WoosimCMD.InitializeStatic(\"com.woosim.printer.W";
parent._woosimcmd.InitializeStatic("com.woosim.printer.WoosimCmd");
 //BA.debugLineNum = 1038;BA.debugLine="WoosimImage.InitializeStatic(\"com.woosim.printer";
parent._woosimimage.InitializeStatic("com.woosim.printer.WoosimImage");
 //BA.debugLineNum = 1040;BA.debugLine="initPrinter = WoosimCMD.RunMethod(\"initPrinter\",";
_initprinter = (byte[])(parent._woosimcmd.RunMethod("initPrinter",(Object[])(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 1041;BA.debugLine="PrintLogo = WoosimImage.RunMethod(\"printBitmap\",";
parent._printlogo = (byte[])(parent._woosimimage.RunMethod("printBitmap",new Object[]{(Object)(0),(Object)(0),(Object)(420),(Object)(220),(Object)(parent._logobmp.getObject())}));
 //BA.debugLineNum = 1043;BA.debugLine="oStream.Write(initPrinter)";
parent._ostream.Write(_initprinter);
 //BA.debugLineNum = 1044;BA.debugLine="oStream.Write(WoosimCMD.RunMethod(\"setPageMode\",";
parent._ostream.Write((byte[])(parent._woosimcmd.RunMethod("setPageMode",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 1045;BA.debugLine="oStream.Write(PrintLogo)";
parent._ostream.Write(parent._printlogo);
 //BA.debugLineNum = 1046;BA.debugLine="oStream.Write(WoosimCMD.RunMethod(\"PM_setStdMode";
parent._ostream.Write((byte[])(parent._woosimcmd.RunMethod("PM_setStdMode",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 1047;BA.debugLine="oStream.Write(PrintLogo)";
parent._ostream.Write(parent._printlogo);
 //BA.debugLineNum = 1049;BA.debugLine="Sleep(500)";
...
this.state = 6;
;
 //BA.debugLineNum = 1050;BA.debugLine="TMPrinter.WriteLine(PrintBuffer)";
parent._tmprinter.WriteLine(parent._printbuffer);
 //BA.debugLineNum = 1051;BA.debugLine="Log(PrintBuffer)";
anywheresoftware.b4a.keywords.Common.LogImpl("18978466",parent._printbuffer,0);
 //BA.debugLineNum = 1052;BA.debugLine="TMPrinter.Flush";
parent._tmprinter.Flush();
 //BA.debugLineNum = 1053;BA.debugLine="Sleep(600)";
...
this.state = 6;
;
 //BA.debugLineNum = 1054;BA.debugLine="If blnNewReg = True Then";
if (true) break;
...
//C
this.state = 11;
 //BA.debugLineNum = 1055;BA.debugLine="ShowSuccessMsg($\"SUCCESS\"$, $\"Stub was successf";
...
//C
this.state = 11;
 //BA.debugLineNum = 1057;BA.debugLine="ShowSuccessMsg($\"REPRINT SUCCESS\"$, $\"Stub was";
...
this.state = 12;
;
 //BA.debugLineNum = 1060;BA.debugLine="TMPrinter.Close";
parent._tmprinter.Close();
 //BA.debugLineNum = 1061;BA.debugLine="Serial1.Disconnect";
...
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 739;BA.debugLine="Private Sub PrinterBinder_OnBindView (View As View";
 //BA.debugLineNum = 740;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 741;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 742;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 743;BA.debugLine="Dim lbl As Label = View";
...
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 744;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 745;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf071)))+"  "));
 //BA.debugLineNum = 746;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 748;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 751;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 752;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 753;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 754;BA.debugLine="lbl.TextColor = Colors.Gray";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 734;BA.debugLine="Private Sub PrinterError_OnPositiveClicked (View A";
 //BA.debugLineNum = 735;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 736;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
...
int _regtableno = 0;
int _attendstatus = 0;
 //BA.debugLineNum = 859;BA.debugLine="Private Sub PrintStub(iRegID As Int)";
 //BA.debugLineNum = 860;BA.debugLine="Dim rsData As Cursor";
_rsdata = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 861;BA.debugLine="Dim StubNo As String";
_stubno = "";
 //BA.debugLineNum = 862;BA.debugLine="Dim RegFullName As String";
_regfullname = "";
 //BA.debugLineNum = 863;BA.debugLine="Dim RegBranchName As String";
_regbranchname = "";
 //BA.debugLineNum = 864;BA.debugLine="Dim RegDivision As String";
_regdivision = "";
 //BA.debugLineNum = 865;BA.debugLine="Dim RegTableNo As Int";
_regtableno = 0;
 //BA.debugLineNum = 866;BA.debugLine="Dim AttendStatus As Int";
_attendstatus = 0;
 //BA.debugLineNum = 868;BA.debugLine="ProgressDialogShow2($\"Stub Printing.  Please Wait";
...
try { //BA.debugLineNum = 871;BA.debugLine="Starter.strCriteria = \"SELECT Employees.RegNo, E";
mostCurrent._starter._strcriteria /*String*/  = "SELECT Employees.RegNo, Employees.FullName, "+"Branches.BranchName, Divisions.DivisionName, Employees.TableNo, "+"Employees.WillAttend AS AttendStatus "+"FROM tblRegistration AS Employees "+"INNER JOIN tblBranches AS Branches ON Employees.BranchID = Branches.BranchID "+"INNER JOIN tblDivisions AS Divisions ON Employees.DivisionID = Divisions.DivisionID "+"WHERE Employees.RegID = "+BA.NumberToString(_iregid)+" "+"AND Employees.WasRegistered = 1";
 //BA.debugLineNum = 880;BA.debugLine="rsData = Starter.DBCon.ExecQuery(Starter.strCrit";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 693;BA.debugLine="Private Sub RegFontSizeBinder_OnBindView (View As";
 //BA.debugLineNum = 694;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 695;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 696;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 697;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 698;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 699;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color(anywheresoftware.b4a.keywords.Common.Colors.Red).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf059)))+"  "));
 //BA.debugLineNum = 700;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 702;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 705;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 706;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 707;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 708;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
...
int _regseq = 0;
int _noprint = 0;
 //BA.debugLineNum = 1085;BA.debugLine="Private Sub RegisterEmp(iRegID As Int) As Boolean";
 //BA.debugLineNum = 1086;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 1087;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 1088;BA.debugLine="Dim TimeReg As String";
_timereg = "";
 //BA.debugLineNum = 1089;BA.debugLine="Dim RegSeq, NoPrint As Int";
_regseq = 0;
_noprint = 0;
 //BA.debugLineNum = 1091;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 1092;BA.debugLine="DateTime.TimeFormat = \"HH:mm:ss\"";
anywheresoftware.b4a.keywords.Common.DateTime.setTimeFormat("HH:mm:ss");
 //BA.debugLineNum = 1093;BA.debugLine="TimeReg = DateTime.Time(lngDateTime)";
_timereg = anywheresoftware.b4a.keywords.Common.DateTime.Time(_lngdatetime);
 //BA.debugLineNum = 1094;BA.debugLine="RegSeq = DBFunctions.GetSeqNo";
_regseq = mostCurrent._dbfunctions._getseqno /*int*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1096;BA.debugLine="NoPrint = GetNoOfStubPrint(iRegID)";
_noprint = _getnoofstubprint(_iregid);
 //BA.debugLineNum = 1097;BA.debugLine="NoPrint = NoPrint + 1";
_noprint = (int) (_noprint+1);
 //BA.debugLineNum = 1098;BA.debugLine="GlobalVar.AssignedEmp = DBFunctions.GetAssignedEm";
mostCurrent._globalvar._assignedemp /*String*/  = mostCurrent._dbfunctions._getassignedemp /*String*/ (mostCurrent.activityBA);
 //BA.debugLineNum = 1100;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 1101;BA.debugLine="Try";
try { //BA.debugLineNum = 1102;BA.debugLine="Starter.strCriteria = \"UPDATE tblRegistration \"";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblRegistration "+"SET WasRegistered = ?, TimeRegistered = ?, "+"RegSeq = ?, WasStubPrint = ?, NoPrintStub = ?, RegisteredBy = ? "+"WHERE RegID = "+BA.NumberToString(_iregid);
 //BA.debugLineNum = 1107;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{("1"),_timereg,BA.NumberToString(_regseq),("1"),BA.NumberToString(_noprint),mostCurrent._globalvar._assignedemp /*String*/ }));
 //BA.debugLineNum = 1110;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 1111;BA.debugLine="ProgressDialogShow2($\"Preparing Stub Printing\"$,";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow2(mostCurrent.activityBA,BA.ObjectToCharSequence(("Preparing Stub Printing")),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 1112;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e20) {
			processBA.setLastException(e20); //BA.debugLineNum = 1114;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 1115;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1116;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19175071",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1118;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 1119;BA.debugLine="Return bRetVal";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 587;BA.debugLine="Private Sub RegisterEmp_OnNegativeClicked (View As";
 //BA.debugLineNum = 588;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 589;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 590;BA.debugLine="ToastMessageShow($\"Canceled!\"$, True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(("Canceled!")),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 591;BA.debugLine="vibration.vibrateCancel";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 594;BA.debugLine="Private Sub RegisterEmp_OnPositiveClicked (View As";
 //BA.debugLineNum = 595;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 596;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 597;BA.debugLine="blnNewReg = True";
_blnnewreg = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 598;BA.debugLine="vibration.vibrateCancel";
_vibration.vibrateCancel(processBA);
 //BA.debugLineNum = 600;BA.debugLine="If Not(RegisterEmp(NewRegID)) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_registeremp(_newregid))) { 
if (true) return "";};
 //BA.debugLineNum = 601;BA.debugLine="PrintStub(NewRegID)";
_printstub(_newregid);
 //BA.debugLineNum = 602;BA.debugLine="ToastMessageShow($\"Registered!\"$, True)";
...
public static String  _searchclosed() throws Exception{
 //BA.debugLineNum = 1308;BA.debugLine="Sub SearchClosed";
 //BA.debugLineNum = 1309;BA.debugLine="SV.ClearSearchBox";
mostCurrent._sv._clearsearchbox /*String*/ ();
 //BA.debugLineNum = 1310;BA.debugLine="SV.ClearAll";
mostCurrent._sv._clearall /*String*/ ();
 //BA.debugLineNum = 1311;BA.debugLine="pnlSearchMain.Visible = False";
...
bwsi.registration.townhall.searchview._item _it = null;
 //BA.debugLineNum = 1189;BA.debugLine="Private Sub SearchSwapEmployees(iBranchID As Int)";
 //BA.debugLineNum = 1190;BA.debugLine="Dim rsSwapEmployees As Cursor";
_rsswapemployees = new anywheresoftware.b4a.sql.SQL.CursorWrapper();
 //BA.debugLineNum = 1191;BA.debugLine="Dim SearchList As List";
_searchlist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 1193;BA.debugLine="If SV.IsInitialized=False Then";
if (mostCurrent._sv.IsInitialized /*boolean*/ ()==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 1194;BA.debugLine="SV.Initialize(Me,\"SV\")";
mostCurrent._sv._initialize /*String*/ (mostCurrent.activityBA,registration.getObject(),"SV");
 };
 //BA.debugLineNum = 1197;BA.debugLine="SV.ClearAll";
mostCurrent._sv._clearall /*String*/ ();
 //BA.debugLineNum = 1198;BA.debugLine="SV.ClearSearchBox";
mostCurrent._sv._clearsearchbox /*String*/ ();
 //BA.debugLineNum = 1199;BA.debugLine="SV.lv.Clear";
mostCurrent._sv._lv /*anywheresoftware.b4a.objects.ListViewWrapper*/ .Clear();
 //BA.debugLineNum = 1201;BA.debugLine="SearchList.Initialize";
_searchlist.Initialize();
 //BA.debugLineNum = 1202;BA.debugLine="SearchList.Clear";
_searchlist.Clear();
 //BA.debugLineNum = 1203;BA.debugLine="Try";
try { //BA.debugLineNum = 1204;BA.debugLine="Starter.strCriteria = \"SELECT tblRegistration.Re";
mostCurrent._starter._strcriteria /*String*/  = "SELECT tblRegistration.RegID, tblRegistration.FullName, tblBranches.BranchName "+"FROM tblRegistration INNER JOIN tblBranches ON tblRegistration.BranchID = tblBranches.BranchID "+"WHERE tblRegistration.WillAttend = 1 "+"AND tblRegistration.WasRegistered = 0 "+"AND tblRegistration.BranchID = "+BA.NumberToString(_ibranchid);
 //BA.debugLineNum = 1210;BA.debugLine="LogColor(Starter.strCriteria, Colors.Cyan)";
anywheresoftware.b4a.keywords.Common.LogImpl("19437205",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Cyan);
 //BA.debugLineNum = 1212;BA.debugLine="rsSwapEmployees = Starter.DBCon.ExecQuery(Starte";
_rsswapemployees = (anywheresoftware.b4a.sql.SQL.CursorWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.CursorWrapper(), (android.database.Cursor)(mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQuery(mostCurrent._starter._strcriteria /*String*/ )));
 //BA.debugLineNum = 1214;BA.debugLine="If rsSwapEmployees.RowCount > 0 Then";
if (_rsswapemployees.getRowCount()>0) { 
 //BA.debugLineNum = 1215;BA.debugLine="For i = 0 To rsSwapEmployees.RowCount - 1";
{
final int step16 = 1;
final int limit16 = (int) (_rsswapemployees.getRowCount()-1);
_i = (int) (0) ;
for (;_i <= limit16 ;_i = _i + step16 ) {
 //BA.debugLineNum = 1216;BA.debugLine="rsSwapEmployees.Position = i";
_rsswapemployees.setPosition(_i);
 //BA.debugLineNum = 1217;BA.debugLine="Dim it As Item";
_it = new bwsi.registration.townhall.searchview._item();
 //BA.debugLineNum = 1218;BA.debugLine="it.Title=rsSwapEmployees.GetString(\"FullName\")";
_it.Title /*String*/  = _rsswapemployees.GetString("FullName");
 //BA.debugLineNum = 1219;BA.debugLine="it.Text=rsSwapEmployees.GetString(\"BranchName\"";
_it.Text /*String*/  = _rsswapemployees.GetString("BranchName");
 //BA.debugLineNum = 1220;BA.debugLine="it.SearchText=rsSwapEmployees.GetString(\"FullN";
_it.SearchText /*String*/  = _rsswapemployees.GetString("FullName").toLowerCase();
 //BA.debugLineNum = 1221;BA.debugLine="it.Value=rsSwapEmployees.GetInt(\"RegID\")";
_it.Value /*Object*/  = (Object)(_rsswapemployees.GetInt("RegID"));
 //BA.debugLineNum = 1222;BA.debugLine="SearchList.Add(it)";
_searchlist.Add((Object)(_it));
 }
};
 }else {
 //BA.debugLineNum = 1225;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 1227;BA.debugLine="SV.SetItems(SearchList)";
mostCurrent._sv._setitems /*Object*/ (_searchlist);
 //BA.debugLineNum = 1228;BA.debugLine="SearchList.Clear";
_searchlist.Clear();
 } 
       catch (Exception e31) {
			processBA.setLastException(e31); //BA.debugLineNum = 1230;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19437225",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1232;BA.debugLine="End Sub";
return "";
}
public static String  _setbuttoncolors() throws Exception{
 //BA.debugLineNum = 464;BA.debugLine="Private Sub SetButtonColors()";
 //BA.debugLineNum = 465;BA.debugLine="btnSwap.Background = CreateButtonColor(0xFF0D47A1";
mostCurrent._btnswap.setBackground((android.graphics.drawable.Drawable)(_createbuttoncolor((int) (0xff0d47a1),(int) (0xff0d47a1),(int) (0xff1e88e5),(int) (0xff0d47a1)).getObject()));
 //BA.debugLineNum = 466;BA.debugLine="btnRegister.Background = CreateButtonColor(0xFF0D";
...
int[] _argb = null;
float _factor = 0f;
 //BA.debugLineNum = 449;BA.debugLine="Sub ShadeColor(clr As Int) As Int";
 //BA.debugLineNum = 450;BA.debugLine="Dim argb() As Int = GetARGB(clr)";
_argb = _getargb(_clr);
 //BA.debugLineNum = 451;BA.debugLine="Dim factor As Float = 3";
_factor = (float) (3);
 //BA.debugLineNum = 452;BA.debugLine="Return xui.Color_RGB(argb(1) * factor, argb(2) *";
...
anywheresoftware.b4a.objects.collections.List _items = null;
 //BA.debugLineNum = 807;BA.debugLine="Private Sub ShowAddPerson";
 //BA.debugLineNum = 808;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 810;BA.debugLine="Dim items As List";
_items = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 811;BA.debugLine="items.Initialize";
_items.Initialize();
 //BA.debugLineNum = 812;BA.debugLine="items.Add(\"New Employee\")";
_items.Add((Object)("New Employee"));
 //BA.debugLineNum = 813;BA.debugLine="items.Add(\"Guest\")";
_items.Add((Object)("Guest"));
 //BA.debugLineNum = 815;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialog").SetStyle(_alert.getSTYLE_ACTIONSHEET()).SetTitle("Select an Option").SetTitleColor(anywheresoftware.b4a.keywords.Common.Colors.Black).SetCancelColor((int) (mostCurrent._globalvar._negcolor /*double*/ )).SetCancelText("Cancel").SetNegativeTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOthers((java.util.ArrayList)(_items.getObject())).SetActionsheetTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnCancelClicked(mostCurrent.activityBA,"AddPeople").SetOnItemClickListener(mostCurrent.activityBA,"AddPeople");
 //BA.debugLineNum = 830;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD).SetCanc";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject())).SetCancelBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 831;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 712;BA.debugLine="Private Sub ShowPrinterError(sTitle As String, sMs";
 //BA.debugLineNum = 713;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 715;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"PrinterError").SetOnViewBinder(mostCurrent.activityBA,"PrinterBinder");
 //BA.debugLineNum = 729;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 730;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 758;BA.debugLine="Private Sub ShowSuccessMsg(sTitle As String, sMsg";
 //BA.debugLineNum = 759;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 761;BA.debugLine="Alert.Initialize.Create _ 			.SetDialogStyleName(";
_alert.Initialize().Create(mostCurrent.activityBA).SetDialogStyleName("MyDialogDisableStatus").SetStyle(_alert.getSTYLE_DIALOGUE()).SetCancelable(anywheresoftware.b4a.keywords.Common.False).SetTitle(_stitle).SetMessage(_smsg).SetPositiveText("OK").SetPositiveColor((int) (mostCurrent._globalvar._poscolor /*double*/ )).SetPositiveTypeface((android.graphics.Typeface)(mostCurrent._globalvar._fontbold /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetTitleTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetMessageTypeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).SetOnPositiveClicked(mostCurrent.activityBA,"SuccessMsg").SetOnViewBinder(mostCurrent.activityBA,"SuccessBinder");
 //BA.debugLineNum = 775;BA.debugLine="Alert.SetDialogBackground(GlobalVar.myCD)";
_alert.SetDialogBackground((android.graphics.drawable.Drawable)(mostCurrent._globalvar._mycd /*anywheresoftware.b4a.objects.drawable.ColorDrawable*/ (mostCurrent.activityBA).getObject()));
 //BA.debugLineNum = 776;BA.debugLine="Alert.Build.Show";
_alert.Build().Show();
...
int _i = 0;
 //BA.debugLineNum = 966;BA.debugLine="Sub StartPrinter";
 //BA.debugLineNum = 968;BA.debugLine="PairedDevices.Initialize";
_paireddevices.Initialize();
 //BA.debugLineNum = 970;BA.debugLine="Try";
try { //BA.debugLineNum = 971;BA.debugLine="PairedDevices = Serial1.GetPairedDevices";
_paireddevices = _serial1.GetPairedDevices();
 } 
       catch (Exception e5) {
			processBA.setLastException(e5); //BA.debugLineNum = 973;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Getting Pa";
_showprintererror(("PRINTER ERROR"),("Getting Paired Devices..."));
 //BA.debugLineNum = 974;BA.debugLine="TMPrinter.Close";
_tmprinter.Close();
 //BA.debugLineNum = 975;BA.debugLine="Serial1.Disconnect";
_serial1.Disconnect();
 };
 //BA.debugLineNum = 978;BA.debugLine="If PairedDevices.Size = 0 Then";
if (_paireddevices.getSize()==0) { 
 //BA.debugLineNum = 979;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Error Conn";
...
if (true) return "";
 ...
 //BA.debugLineNum = 983;BA.debugLine="If PairedDevices.Size = 1 Then";
if (_paireddevices.getSize()==1) { 
 //BA.debugLineNum = 984;BA.debugLine="Try";
try { //BA.debugLineNum = 985;BA.debugLine="DeviceName=PairedDevices.Getkeyat(0)";
_devicename = BA.ObjectToString(_paireddevices.GetKeyAt((int) (0)));
 //BA.debugLineNum = 986;BA.debugLine="DeviceMac=PairedDevices.GetValueAt(0)";
_devicemac = BA.ObjectToString(_paireddevices.GetValueAt((int) (0)));
 //BA.debugLineNum = 987;BA.debugLine="Log(DeviceName & \" -> \" & DeviceMac)";
anywheresoftware.b4a.keywords.Common.LogImpl("18912917",_devicename+" -> "+_devicemac,0);
 //BA.debugLineNum = 989;BA.debugLine="Serial1.ConnectInsecure(BTAdmin, DeviceMac,1)";
_serial1.ConnectInsecure(processBA,_btadmin,_devicemac,(int) (1));
 //BA.debugLineNum = 990;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 } 
       catch (Exception e21) {
			processBA.setLastException(e21); //BA.debugLineNum = 992;BA.debugLine="ShowPrinterError($\"PRINTER ERROR\"$, $\"Printer C";
_showprintererror(("PRINTER ERROR"),("Printer Connection Error..."));
 //BA.debugLineNum = 993;BA.debugLine="TMPrinter.Close";
_tmprinter.Close();
 //BA.debugLineNum = 994;BA.debugLine="Serial1.Disconnect";
_serial1.Disconnect();
 };
 }else {
 //BA.debugLineNum = 997;BA.debugLine="FoundDevices.Initialize";
_founddevices.Initialize();
 //BA.debugLineNum = 999;BA.debugLine="For i = 0 To PairedDevices.Size - 1";
{
final int step27 = 1;
final int limit27 = (int) (_paireddevices.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit27 ;_i = _i + step27 ) {
 //BA.debugLineNum = 1000;BA.debugLine="FoundDevices.Add(PairedDevices.GetKeyAt(i))";
_founddevices.Add(_paireddevices.GetKeyAt(_i));
 //BA.debugLineNum = 1001;BA.debugLine="DeviceName=PairedDevices.Getkeyat(i)";
_devicename = BA.ObjectToString(_paireddevices.GetKeyAt(_i));
 //BA.debugLineNum = 1002;BA.debugLine="DeviceMac=PairedDevices.GetValueAt(i)";
_devicemac = BA.ObjectToString(_paireddevices.GetValueAt(_i));
 //BA.debugLineNum = 1003;BA.debugLine="Log(DeviceName & \" -> \" & DeviceMac)";
anywheresoftware.b4a.keywords.Common.LogImpl("18912933",_devicename+" -> "+_devicemac,0);
 //BA.debugLineNum = 1004;BA.debugLine="Serial1.ConnectInsecure(BTAdmin, DeviceMac,1)";
_serial1.ConnectInsecure(processBA,_btadmin,_devicemac,(int) (1));
 //BA.debugLineNum = 1005;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 1006;BA.debugLine="Exit";
if (true) break;
 }
};
 //BA.debugLineNum = 1009;BA.debugLine="Res = InputList(FoundDevices, \"Choose Device\", -";
_res = anywheresoftware.b4a.keywords.Common.InputList(_founddevices,BA.ObjectToCharSequence("Choose Device"),(int) (-1),mostCurrent.activityBA);
 //BA.debugLineNum = 1011;BA.debugLine="If Res <> DialogResponse.CANCEL Then";
if (_res!=anywheresoftware.b4a.keywords.Common.DialogResponse.CANCEL) { 
 //BA.debugLineNum = 1012;BA.debugLine="Serial1.Connect(PairedDevices.Get(FoundDevices.";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 632;BA.debugLine="Private Sub StubReprint_OnNegativeClicked (View As";
 //BA.debugLineNum = 633;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 634;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 635;BA.debugLine="ToastMessageShow($\"Reprinting Cancelled!\"$, True)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 638;BA.debugLine="Private Sub StubReprint_OnPositiveClicked (View As";
 //BA.debugLineNum = 639;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 640;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 642;BA.debugLine="blnNewReg = False";
_blnnewreg = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 644;BA.debugLine="If Not(UpdateReprintStub(NewRegID)) Then Return";
if (anywheresoftware.b4a.keywords.Common.Not(_updatereprintstub(_newregid))) { 
if (true) return "";};
 //BA.debugLineNum = 645;BA.debugLine="PrintStub(NewRegID)";
_printstub(_newregid);
 //BA.debugLineNum = 646;BA.debugLine="ToastMessageShow($\"Reprinted!\"$, True)";
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
anywheresoftware.b4a.objects.CSBuilder _cs = null;
 //BA.debugLineNum = 788;BA.debugLine="Private Sub SuccessBinder_OnBindView (View As View";
 //BA.debugLineNum = 789;BA.debugLine="Dim alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 790;BA.debugLine="alert.Initialize";
_alert.Initialize();
 //BA.debugLineNum = 791;BA.debugLine="If ViewType = alert.VIEW_TITLE Then ' Title";
if (_viewtype==_alert.VIEW_TITLE) { 
 //BA.debugLineNum = 792;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 793;BA.debugLine="Dim CS As CSBuilder";
_cs = new anywheresoftware.b4a.objects.CSBuilder();
 //BA.debugLineNum = 794;BA.debugLine="CS.Initialize.Typeface(Typeface.DEFAULT_BOLD).Ty";
_cs.Initialize().Typeface(anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD).Typeface(anywheresoftware.b4a.keywords.Common.Typeface.getFONTAWESOME()).Size((int) (20)).Color((int) (mostCurrent._globalvar._poscolor /*double*/ )).Append(BA.ObjectToCharSequence(BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr((int) (0xf164)))+"  "));
 //BA.debugLineNum = 795;BA.debugLine="CS.Typeface(GlobalVar.Font).Size(18).Append(lbl.";
_cs.Typeface((android.graphics.Typeface)(mostCurrent._globalvar._font /*anywheresoftware.b4a.keywords.constants.TypefaceWrapper*/ .getObject())).Size((int) (18)).Append(BA.ObjectToCharSequence(_lbl.getText())).Pop();
 //BA.debugLineNum = 797;BA.debugLine="lbl.Text = CS.PopAll";
_lbl.setText(BA.ObjectToCharSequence(_cs.PopAll().getObject()));
 };
 //BA.debugLineNum = 800;BA.debugLine="If ViewType = alert.VIEW_MESSAGE Then";
if (_viewtype==_alert.VIEW_MESSAGE) { 
 //BA.debugLineNum = 801;BA.debugLine="Dim lbl As Label = View";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_view.getObject()));
 //BA.debugLineNum = 802;BA.debugLine="lbl.TextSize = 16";
_lbl.setTextSize((float) (16));
 //BA.debugLineNum = 803;BA.debugLine="lbl.TextColor = Colors.Gray";
_lbl.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Gray);
 };
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 780;BA.debugLine="Private Sub SuccessMsg_OnPositiveClicked (View As";
 //BA.debugLineNum = 781;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 782;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 783;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtSearch.T";
...
mostCurrent._txtsearch.setText(BA.ObjectToCharSequence(""));};
 //BA.debugLineNum = 784;BA.debugLine="FillEmployees(GlobalVar.AreaID)";
_fillemployees(mostCurrent._globalvar._areaid /*int*/ );
 //BA.debugLineNum = 786;BA.debugLine="End Sub";
return "";
}
public static String  _sv_itemclick(int _value) throws Exception{
 //BA.debugLineNum = 1257;BA.debugLine="Sub SV_ItemClick(Value As Int)";
 //BA.debugLineNum = 1258;BA.debugLine="Log(Value)";
anywheresoftware.b4a.keywords.Common.LogImpl("19568257",BA.NumberToString(_value),0);
 //BA.debugLineNum = 1259;BA.debugLine="iSwapEmpID = Value";
_iswapempid = _value;
 //BA.debugLineNum = 1260;BA.debugLine="SV.ClearAll";
mostCurrent._sv._clearall /*String*/ ();
 //BA.debugLineNum = 1261;BA.debugLine="SearchClosed";
_searchclosed();
 //BA.debugLineNum = 1263;BA.debugLine="sSwapEmp = GetSwapEmployeeName(iSwapEmpID)";
mostCurrent._sswapemp = _getswapemployeename(_iswapempid);
 //BA.debugLineNum = 1264;BA.debugLine="sSwapTableNo = GetSwapTableNo(iSwapEmpID)";
mostCurrent._sswaptableno = _getswaptableno(_iswapempid);
 //BA.debugLineNum = 1266;BA.debugLine="If sSwapEmp = \"\" Then Return";
if ((mostCurrent._sswapemp).equals("")) { 
if (true) return "";};
 //BA.debugLineNum = 1267;BA.debugLine="vibration.vibratePattern(vibratePattern, 0)";
_vibration.vibratePattern(processBA,_vibratepattern,(int) (0));
 //BA.debugLineNum = 1268;BA.debugLine="ConfirmSwapEmp(sSwapEmp)";
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 676;BA.debugLine="Private Sub SwapEmp_OnNegativeClicked (View As Vie";
...
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 679;BA.debugLine="ToastMessageShow($\"Canceled!\"$, True)";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(("Canceled!")),anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 680;BA.debugLine="vibration.vibrateCancel";
_vibration.vibrateCancel(processBA);
...
com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder _alert = null;
 //BA.debugLineNum = 683;BA.debugLine="Private Sub SwapEmp_OnPositiveClicked (View As Vie";
 //BA.debugLineNum = 684;BA.debugLine="Dim Alert As AX_CustomAlertDialog";
_alert = new com.aghajari.ax_customalertviewdialog.AX_CustomAlertDialogBuilder();
 //BA.debugLineNum = 685;BA.debugLine="Alert.Initialize.Dismiss(Dialog)";
_alert.Initialize().Dismiss((android.app.Dialog)(_dialog));
 //BA.debugLineNum = 686;BA.debugLine="vibration.vibrateCancel";
_vibration.vibrateCancel(processBA);
 //BA.debugLineNum = 687;BA.debugLine="If UpdateSwappedEmp(iSwapEmpID, SwapRegID) = Fals";
if (_updateswappedemp(_iswapempid,_swapregid)==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 688;BA.debugLine="If RegisterEmp(SwapRegID) = False Then Return";
if (_registeremp(_swapregid)==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 689;BA.debugLine="PrintStub(SwapRegID)";
_printstub(_swapregid);
...
public static String  _toolbar_menuitemclick(de.amberhome.objects.appcompat.ACMenuItemWrapper _item) throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub ToolBar_MenuItemClick (Item As ACMenuItem)";
 //BA.debugLineNum = 231;BA.debugLine="Select Case Item.Id";
switch (BA.switchObjectToInt(_item.getId(),(int) (1))) {
case 0: {
 //BA.debugLineNum = 233;BA.debugLine="ShowAddPerson";
_showaddperson();
 break; }
}
;
...
public static String  _toolbar_navigationitemclick() throws Exception{
 //BA.debugLineNum = 220;BA.debugLine="Sub ToolBar_NavigationItemClick";
 //BA.debugLineNum = 221;BA.debugLine="If GlobalVar.SF.Len(GlobalVar.SF.Trim(txtSearch.T";
if (mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv7(mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv4(mostCurrent._txtsearch.getText()))<=0) { 
 //BA.debugLineNum = 222;BA.debugLine="IMEKeyboard.HideKeyboard";
mostCurrent._imekeyboard.HideKeyboard(mostCurrent.activityBA);
 //BA.debugLineNum = 223;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 }else {
 //BA.debugLineNum = 225;BA.debugLine="txtSearch.Text = \"\"";
mostCurrent._txtsearch.setText(BA.ObjectToCharSequence(""));
 //BA.debugLineNum = 226;BA.debugLine="IMEKeyboard.HideKeyboard";
mostCurrent._imekeyboard.HideKeyboard(mostCurrent.activityBA);
 };
...
//C
this.state = 1;
 //BA.debugLineNum = 494;BA.debugLine="If New.Length = 1 Or txtSearch.Text.Length = 2 Th";
if (true) break;
...
this.state = 7;
;
 //BA.debugLineNum = 496;BA.debugLine="clvEmployees.Clear";
parent.mostCurrent._clvemployees._clear();
...
this.state = 7;
;
 //BA.debugLineNum = 499;BA.debugLine="Dim SenderFilter As Object";
_senderfilter = new Object();
 //BA.debugLineNum = 501;BA.debugLine="If New.Length = 0  Then";
if (true) break;
...
//C
this.state = 12;
 //BA.debugLineNum = 502;BA.debugLine="FillEmployees(GlobalVar.AreaID)";
_fillemployees(parent.mostCurrent._globalvar._areaid /*int*/ );
 if (true) break;

case 11:
//C
this.state = 12;
 //BA.debugLineNum = 504;BA.debugLine="Starter.strCriteria = \"SELECT Employees.BranchID";
...
this.state = 13;
;
 //BA.debugLineNum = 520;BA.debugLine="LogColor(Starter.strCriteria, Colors.Yellow)";
anywheresoftware.b4a.keywords.Common.LogImpl("17536667",parent.mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Yellow);
 //BA.debugLineNum = 521;BA.debugLine="SenderFilter = Starter.DBCon.ExecQueryAsync(\"SQL\"";
_senderfilter = parent.mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecQueryAsync(processBA,"SQL",parent.mostCurrent._starter._strcriteria /*String*/ ,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(anywheresoftware.b4a.keywords.Common.Null)));
 //BA.debugLineNum = 523;BA.debugLine="Wait For (SenderFilter) SQL_QueryComplete (Succes";
anywheresoftware.b4a.keywords.Common.WaitFor("sql_querycomplete", processBA, this, _senderfilter);
this.state = 31;
return;
case 31:
...
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) result[1];
;
 //BA.debugLineNum = 524;BA.debugLine="If Success Then";
if (true) break;
...
//C
this.state = 16;
 //BA.debugLineNum = 525;BA.debugLine="Dim StartTime As Long = DateTime.Now";
_starttime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 526;BA.debugLine="clvEmployees.Clear";
parent.mostCurrent._clvemployees._clear();
...
//C
this.state = 16;
 //BA.debugLineNum = 528;BA.debugLine="Dim EmpInfo As EmployeeInfo";
_empinfo = new bwsi.registration.townhall.registration._employeeinfo();
 //BA.debugLineNum = 529;BA.debugLine="EmpInfo.Initialize";
_empinfo.Initialize();
 //BA.debugLineNum = 530;BA.debugLine="EmpInfo.RegID = RS.GetInt(\"RegID\")";
_empinfo.RegID /*int*/  = _rs.GetInt("RegID");
 //BA.debugLineNum = 531;BA.debugLine="EmpInfo.RegNo = RS.GetString(\"RegNo\")";
_empinfo.RegNo /*String*/  = _rs.GetString("RegNo");
 //BA.debugLineNum = 532;BA.debugLine="EmpInfo.BranchID = RS.GetInt(\"BranchID\")";
_empinfo.BranchID /*int*/  = _rs.GetInt("BranchID");
 //BA.debugLineNum = 533;BA.debugLine="EmpInfo.BranchName = RS.GetString(\"BranchName\")";
_empinfo.BranchName /*String*/  = _rs.GetString("BranchName");
 //BA.debugLineNum = 534;BA.debugLine="EmpInfo.EmpName = RS.GetString(\"FullName\")";
_empinfo.EmpName /*String*/  = _rs.GetString("FullName");
 //BA.debugLineNum = 535;BA.debugLine="EmpInfo.EmpDivision = RS.GetString(\"DivisionNam";
_empinfo.EmpDivision /*String*/  = _rs.GetString("DivisionName");
 //BA.debugLineNum = 536;BA.debugLine="EmpInfo.Avatar = GlobalVar.SF.Upper(GlobalVar.S";
_empinfo.Avatar /*String*/  = parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv6(_rs.GetString("FirstName"),(long) (1)))+parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvvvvvv5(parent.mostCurrent._globalvar._sf /*adr.stringfunctions.stringfunctions*/ ._vvv6(_rs.GetString("LastName"),(long) (1)));
 //BA.debugLineNum = 537;BA.debugLine="EmpInfo.WillAttend = RS.GetInt(\"WillAttend\")";
_empinfo.WillAttend /*int*/  = _rs.GetInt("WillAttend");
 //BA.debugLineNum = 538;BA.debugLine="EmpInfo.RegStatus = RS.GetInt(\"WasRegistered\")";
_empinfo.RegStatus /*int*/  = _rs.GetInt("WasRegistered");
 //BA.debugLineNum = 540;BA.debugLine="Dim Pnl As B4XView = xui.CreatePanel(\"\")";
_pnl = new anywheresoftware.b4a.objects.B4XViewWrapper();
_pnl = parent._xui.CreatePanel(processBA,"");
 //BA.debugLineNum = 541;BA.debugLine="Pnl.SetLayoutAnimated(0, 10dip, 0, clvEmployees";
_pnl.SetLayoutAnimated((int) (0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),parent.mostCurrent._clvemployees._asview().getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (180)));
 //BA.debugLineNum = 542;BA.debugLine="clvEmployees.Add(Pnl, EmpInfo)";
parent.mostCurrent._clvemployees._add(_pnl,(Object)(_empinfo));
 if (true) break;
;
 //BA.debugLineNum = 544;BA.debugLine="If RS.RowCount <= 0 Then";
...
//C
this.state = 26;
 //BA.debugLineNum = 545;BA.debugLine="lblRecCount.Text = $\"No Employee Found\"$";
parent.mostCurrent._lblreccount.setText(BA.ObjectToCharSequence(("No Employee Found")));
 if (true) break;
...
//C
this.state = 26;
 //BA.debugLineNum = 547;BA.debugLine="lblRecCount.Text = RS.RowCount & $\" Employee Fo";
parent.mostCurrent._lblreccount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+(" Employee Found")));
 if (true) break;
...
//C
this.state = 26;
 //BA.debugLineNum = 549;BA.debugLine="lblRecCount.Text = RS.RowCount & $\" Employees F";
parent.mostCurrent._lblreccount.setText(BA.ObjectToCharSequence(BA.NumberToString(_rs.getRowCount())+(" Employees Found")));
 if (true) break;
...
anywheresoftware.b4a.keywords.Common.LogImpl("17536699",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 555;BA.debugLine="Log($\"List of Employees Records = ${NumberFormat2";
anywheresoftware.b4a.keywords.Common.LogImpl("17536702",("List of Employees Records = "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(anywheresoftware.b4a.keywords.Common.NumberFormat2((anywheresoftware.b4a.keywords.Common.DateTime.getNow()-_starttime)/(double)1000,(int) (0),(int) (2),(int) (2),anywheresoftware.b4a.keywords.Common.False)))+" seconds to populate "+anywheresoftware.b4a.keywords.Common.SmartStringFormatter("",(Object)(parent.mostCurrent._clvemployees._getsize()))+" Employees Records"),0);
...
String _reprinttime = "";
long _lngdatetime = 0L;
 //BA.debugLineNum = 1122;BA.debugLine="Private Sub UpdateReprintStub(iRegID As Int) As Bo";
 //BA.debugLineNum = 1123;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 1124;BA.debugLine="Dim NoPrint As Int";
_noprint = 0;
 //BA.debugLineNum = 1125;BA.debugLine="Dim ReprintTime As String";
_reprinttime = "";
 //BA.debugLineNum = 1126;BA.debugLine="Dim lngDateTime As Long";
_lngdatetime = 0L;
 //BA.debugLineNum = 1128;BA.debugLine="lngDateTime = DateTime.Now";
_lngdatetime = anywheresoftware.b4a.keywords.Common.DateTime.getNow();
 //BA.debugLineNum = 1129;BA.debugLine="DateTime.TimeFormat = \"HH:mm:ss\"";
anywheresoftware.b4a.keywords.Common.DateTime.setTimeFormat("HH:mm:ss");
 //BA.debugLineNum = 1130;BA.debugLine="ReprintTime = DateTime.Time(lngDateTime)";
_reprinttime = anywheresoftware.b4a.keywords.Common.DateTime.Time(_lngdatetime);
 //BA.debugLineNum = 1133;BA.debugLine="NoPrint = GetNoOfStubPrint(iRegID)";
_noprint = _getnoofstubprint(_iregid);
 //BA.debugLineNum = 1134;BA.debugLine="NoPrint = NoPrint + 1";
_noprint = (int) (_noprint+1);
 //BA.debugLineNum = 1136;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 1137;BA.debugLine="Try";
try { //BA.debugLineNum = 1138;BA.debugLine="Starter.strCriteria = \"UPDATE tblRegistration \"";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblRegistration "+"SET NoPrintStub = ?, LastReprintedTime = ?  "+"WHERE RegID = "+BA.NumberToString(_iregid);
 //BA.debugLineNum = 1142;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
...
_bretval = anywheresoftware.b4a.keywords.Common.True;
			...
			processBA.setLastException(e18); //BA.debugLineNum = 1148;BA.debugLine="ProgressDialogHide";
anywheresoftware.b4a.keywords.Common.ProgressDialogHide();
 //BA.debugLineNum = 1149;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1150;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19240604",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
boolean _bretval = false;
 //BA.debugLineNum = 1272;BA.debugLine="Private Sub UpdateSwappedEmp(iSwapEmp As Int, iReg";
 //BA.debugLineNum = 1273;BA.debugLine="Dim bRetVal As Boolean";
_bretval = false;
 //BA.debugLineNum = 1275;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1276;BA.debugLine="Starter.DBCon.BeginTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .BeginTransaction();
 //BA.debugLineNum = 1277;BA.debugLine="Try";
try { //BA.debugLineNum = 1279;BA.debugLine="Starter.strCriteria = \"UPDATE tblRegistration \"";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblRegistration "+"SET TableNo = ?, WasSwapped = ?, SwappedTo = ?, WillAttend = ?"+"WHERE RegID = "+BA.NumberToString(_iregid);
 //BA.debugLineNum = 1282;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{mostCurrent._sswaptableno,("1"),mostCurrent._sswapemp,("1")}));
 //BA.debugLineNum = 1284;BA.debugLine="Starter.strCriteria = \"UPDATE tblRegistration \"";
mostCurrent._starter._strcriteria /*String*/  = "UPDATE tblRegistration "+"SET WillAttend = ?"+"WHERE RegID = "+BA.NumberToString(_iswapemp);
 //BA.debugLineNum = 1287;BA.debugLine="Starter.DBCon.ExecNonQuery2(Starter.strCriteria,";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .ExecNonQuery2(mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.ArrayToList(new String[]{("2")}));
 //BA.debugLineNum = 1288;BA.debugLine="Starter.DBCon.TransactionSuccessful";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .TransactionSuccessful();
 //BA.debugLineNum = 1289;BA.debugLine="bRetVal = True";
_bretval = anywheresoftware.b4a.keywords.Common.True;
 } 
       catch (Exception e12) {
			processBA.setLastException(e12); //BA.debugLineNum = 1291;BA.debugLine="bRetVal = False";
_bretval = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 1292;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("19633812",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
 //BA.debugLineNum = 1294;BA.debugLine="Starter.DBCon.EndTransaction";
mostCurrent._starter._dbcon /*anywheresoftware.b4a.sql.SQL*/ .EndTransaction();
 //BA.debugLineNum = 1295;BA.debugLine="Return bRetVal";
if (true) return _bretval;

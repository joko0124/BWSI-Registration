...
public class customlistview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.townhall.customlistview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.townhall.customlistview.class).invoke(this, new Object[] {null});
        else
...
public int _firstvisibleindex = 0;
public int _lastvisibleindex = 0;
...
_su = new anywheresoftware.b4a.objects.StringUtils();
 //BA.debugLineNum = 35;BA.debugLine="Private FirstVisibleIndex = -1, LastVisibleIndex";
_firstvisibleindex = (int) (-1);
_lastvisibleindex = (int) (0x7fffffff);
...
anywheresoftware.b4a.objects.LabelWrapper _lbl = null;
 //BA.debugLineNum = 471;BA.debugLine="Private Sub CreateLabel(txt As Object) As B4XView";
 //BA.debugLineNum = 472;BA.debugLine="Dim lbl As Label";
_lbl = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 473;BA.debugLine="lbl.Initialize(\"\")";
_lbl.Initialize(ba,"");
 //BA.debugLineNum = 474;BA.debugLine="lbl.Gravity = DesignerLabel.Gravity";
_lbl.setGravity(_designerlabel.getGravity());
 //BA.debugLineNum = 475;BA.debugLine="lbl.TextSize = DesignerLabel.TextSize";
_lbl.setTextSize(_designerlabel.getTextSize());
 //BA.debugLineNum = 476;BA.debugLine="lbl.SingleLine = False";
_lbl.setSingleLine(__c.False);
 //BA.debugLineNum = 477;BA.debugLine="lbl.Text = txt";
_lbl.setText(BA.ObjectToCharSequence(_txt));
 //BA.debugLineNum = 478;BA.debugLine="lbl.Width = sv.ScrollViewContentWidth - 10dip";
_lbl.setWidth((int) (_sv.getScrollViewContentWidth()-__c.DipToCurrent((int) (10))));
 //BA.debugLineNum = 479;BA.debugLine="lbl.Height = su.MeasureMultilineTextHeight(lbl, t";
_lbl.setHeight(_su.MeasureMultilineTextHeight((android.widget.TextView)(_lbl.getObject()),BA.ObjectToCharSequence(_txt)));
 //BA.debugLineNum = 480;BA.debugLine="Return lbl";
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _createpanel(String _paneleventname) throws Exception{
 //BA.debugLineNum = 442;BA.debugLine="Private Sub CreatePanel (PanelEventName As String)";
 //BA.debugLineNum = 443;BA.debugLine="Return xui.CreatePanel(PanelEventName)";
...
anywheresoftware.b4a.objects.ScrollViewWrapper _nsv = null;
 //BA.debugLineNum = 451;BA.debugLine="Private Sub CreateScrollView As B4XView";
 //BA.debugLineNum = 452;BA.debugLine="If horizontal Then";
if (_horizontal) { 
 //BA.debugLineNum = 453;BA.debugLine="Dim hv As HorizontalScrollView";
_hv = new anywheresoftware.b4a.objects.HorizontalScrollViewWrapper();
 //BA.debugLineNum = 454;BA.debugLine="hv.Initialize(0, \"sv\")";
_hv.Initialize(ba,(int) (0),"sv");
 //BA.debugLineNum = 455;BA.debugLine="Return hv";
if (true) return (anywheresoftware.b4a.objects.B4XViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.B4XViewWrapper(), (java.lang.Object)(_hv.getObject()));
 ...
 //BA.debugLineNum = 457;BA.debugLine="Dim nsv As ScrollView";
_nsv = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 458;BA.debugLine="nsv.Initialize2(0, \"sv\")";
_nsv.Initialize2(ba,(int) (0),"sv");
 //BA.debugLineNum = 459;BA.debugLine="Return nsv";
...
_setscrollviewcontentsize((float) (_getscrollviewcontentsize()+_includedividierheight));};
 //BA.debugLineNum = 247;BA.debugLine="If Index < LastVisibleIndex Or GetItem(LastVisibl";
if (_index<_lastvisibleindex || _getitem(_lastvisibleindex).Offset+_getitem(_lastvisibleindex).Size+_dividersize<_getscrollviewvisiblesize()) { 
...
__c.LogImpl("121102594","AddTextItem is only supported in vertical orientation.",0);
...
public String  _panel_click() throws Exception{
 //BA.debugLineNum = 463;BA.debugLine="Private Sub Panel_Click";
 //BA.debugLineNum = 464;BA.debugLine="PanelClickHandler(Sender)";
...
public ResumableSub_PanelClickHandler(bwsi.registration.townhall.customlistview parent,anywheresoftware.b4a.objects.B4XViewWrapper _senderpanel) {
this.parent = parent;
this._senderpanel = _senderpanel;
}
bwsi.registration.townhall.customlistview parent;
...
_p.setTag((Object)(_i-1));
 //BA.debugLineNum = 136;BA.debugLine="Dim NewOffset As Int = item.Offset - item.Size -";
_newoffset = (int) (_item.Offset-_item.Size-_dividersize);
...
int _position = 0;
 ...
 //BA.debugLineNum = 427;BA.debugLine="Dim position As Int = GetScrollViewOffset";
_position = (int) (_getscrollviewoffset());
 //BA.debugLineNum = 428;BA.debugLine="If position + GetScrollViewVisibleSize >= GetScro";
if (_position+_getscrollviewvisiblesize()>=_getscrollviewcontentsize()-__c.DipToCurrent((int) (5)) && __c.DateTime.getNow()>_lastreachendevent+100) { 
 //BA.debugLineNum = 429;BA.debugLine="If xui.SubExists(CallBack, EventName & \"_ReachEn";
if (_xui.SubExists(ba,_callback,_eventname+"_ReachEnd",(int) (0))) { 
 //BA.debugLineNum = 430;BA.debugLine="LastReachEndEvent = DateTime.Now";
_lastreachendevent = __c.DateTime.getNow();
 //BA.debugLineNum = 431;BA.debugLine="CallSubDelayed(CallBack, EventName & \"_ReachEnd";
__c.CallSubDelayed(ba,_callback,_eventname+"_ReachEnd");
 }else {
 //BA.debugLineNum = 433;BA.debugLine="LastReachEndEvent = DateTime.Now + 1000 * DateT";
_lastreachendevent = (long) (__c.DateTime.getNow()+1000*__c.DateTime.TicksPerDay);
 };
 };
 //BA.debugLineNum = 436;BA.debugLine="UpdateVisibleRange";
_updatevisiblerange();
 //BA.debugLineNum = 437;BA.debugLine="If FireScrollChanged Then";
if (_firescrollchanged) { 
 //BA.debugLineNum = 438;BA.debugLine="CallSub2(CallBack, EventName & \"_ScrollChanged\",";
...
public String  _sv_scrollchanged(int _position) throws Exception{
 //BA.debugLineNum = 467;BA.debugLine="Private Sub sv_ScrollChanged(Position As Int)";
 //BA.debugLineNum = 468;BA.debugLine="ScrollHandler";
_scrollhandler();
...
_last = _getlastvisibleindex();
 //BA.debugLineNum = 257;BA.debugLine="If first <> FirstVisibleIndex Or last <> LastVisi";
if (_first!=_firstvisibleindex || _last!=_lastvisibleindex) { 
 //BA.debugLineNum = 258;BA.debugLine="FirstVisibleIndex = first";
_firstvisibleindex = _first;
 //BA.debugLineNum = 259;BA.debugLine="LastVisibleIndex = last";
_lastvisibleindex = _last;
 //BA.debugLineNum = 260;BA.debugLine="CallSubDelayed3(CallBack, EventName & \"_VisibleR";
__c.CallSubDelayed3(ba,_callback,_eventname+"_VisibleRangeChanged",(Object)(_firstvisibleindex),(Object)(_lastvisibleindex));
 };

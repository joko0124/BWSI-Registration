...
public class clvexpandable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.townhall.clvexpandable");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.townhall.clvexpandable.class).invoke(this, new Object[] {null});
        else
...
public bwsi.registration.townhall.clvexpandable._expandableitemdata  _createvalue(anywheresoftware.b4a.objects.B4XViewWrapper _pnl,Object _value) throws Exception{
bwsi.registration.townhall.clvexpandable._expandableitemdata _e = null;
...
_e = new bwsi.registration.townhall.clvexpandable._expandableitemdata();
...
if (_mclv._getvalue(_index) instanceof bwsi.registration.townhall.clvexpandable._expandableitemdata) { 
 //BA.debugLineNum = 23;BA.debugLine="Dim e As ExpandableItemData = mCLV.GetValue(Inde";
_e = (bwsi.registration.townhall.clvexpandable._expandableitemdata)(_mclv._getvalue(_index));
...
public ResumableSub_ResizeItem(bwsi.registration.townhall.clvexpandable parent,int _index,boolean _collapse) {
this.parent = parent;
this._index = _index;
this._collapse = _collapse;
}
bwsi.registration.townhall.clvexpandable parent;
int _index;
boolean _collapse;
b4a.example3.customlistview._clvitem _item = null;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
anywheresoftware.b4a.objects.B4XViewWrapper _newpanel = null;
bwsi.registration.townhall.clvexpandable._expandableitemdata _id = null;
int _newsize = 0;
...
//if
this.state = 6;
if (_p.getNumberOfViews()==0 || (_item.Value instanceof bwsi.registration.townhall.clvexpandable._expandableitemdata)==parent.__c.False) { 
this.state = 3;
;}if (true) break;
...
_id = (bwsi.registration.townhall.clvexpandable._expandableitemdata)(_item.Value);
...
bwsi.registration.townhall.clvexpandable._expandableitemdata _i = null;
...
_i = (bwsi.registration.townhall.clvexpandable._expandableitemdata)(_mclv._getvalue(_index));

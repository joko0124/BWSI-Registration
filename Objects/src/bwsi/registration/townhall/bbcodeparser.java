...
public class bbcodeparser extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.townhall.bbcodeparser");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.townhall.bbcodeparser.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public bwsi.registration.townhall.b4xset _allowedtags = null;
...
_allowedtags = new bwsi.registration.townhall.b4xset();
...
public anywheresoftware.b4a.objects.collections.List  _createruns(anywheresoftware.b4a.objects.collections.List _texts,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
anywheresoftware.b4a.objects.collections.List _runs = null;
bwsi.registration.townhall.bbcodeparser._bbcodetextnode _textnode = null;
...
_textnode = (bwsi.registration.townhall.bbcodeparser._bbcodetextnode)(group3.Get(index3));
...
public bwsi.registration.townhall.bbcodeparser._bbcodetagnode  _createtagnode(String _tag) throws Exception{
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _n = null;
...
_n = new bwsi.registration.townhall.bbcodeparser._bbcodetagnode();
...
public bwsi.registration.townhall.bbcodeparser._bbcodetextnode  _createtextnode(String _text) throws Exception{
bwsi.registration.townhall.bbcodeparser._bbcodetextnode _n = null;
...
_n = new bwsi.registration.townhall.bbcodeparser._bbcodetextnode();
...
__c.LogImpl("935586051",_s,__c.Colors.Red);
 //BA.debugLineNum = 160;BA.debugLine="ErrorString.Append(s).Append(CRLF)";
_errorstring.Append(_s).Append(__c.CRLF);
 //BA.debugLineNum = 161;BA.debugLine="End Sub";
return "";
}
public int  _getdimensionfromtag(bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag,String _key,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _s = "";
int _i = 0;
float _v = 0f;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getview(bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
String _id = "";
...
public bwsi.registration.townhall.bctextengine._bctextrun  _handlelistelement(bwsi.registration.townhall.bbcodeparser._bbcodetextnode _text,bwsi.registration.townhall.bctextengine._bctextrun _run) throws Exception{
int _i = 0;
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag = null;
String _liststyle = "";
int _count = 0;
...
_tag = (bwsi.registration.townhall.bbcodeparser._bbcodetagnode)(_text.Tags /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
_run.TextChars /*bwsi.registration.townhall.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*bwsi.registration.townhall.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr((int) (0x2022)))+" ");
 }else {
...
_parent = _mtextengine._createconnectedparent /*bwsi.registration.townhall.bctextengine._bctextrun*/ ();
 //BA.debugLineNum = 343;BA.debugLine="Run.TextChars = mTextEngine.CreateBCTextCharsF";
_run.TextChars /*bwsi.registration.townhall.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*bwsi.registration.townhall.bctextengine._bctextchars*/ (BA.NumberToString((_count))+". ");
 //BA.debugLineNum = 344;BA.debugLine="Dim cr As BCConnectedRuns = parent.Extra.Get(m";
_cr = (bwsi.registration.townhall.bctextengine._bcconnectedruns)(_parent.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_mtextengine._extra_connectedruns /*String*/ )));
...
_cr.ConnectedWidth /*int*/  = (int) (_mtextengine._getfontmetrics /*bwsi.registration.townhall.bctextengine._bcfontmetrics*/ (_run.TextFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/ ,_run.TextColor /*int*/ ).xWidth /*int*/ *3/(double)_mtextengine._mscale /*float*/ );
...
public String  _initialize(anywheresoftware.b4a.BA _ba,bwsi.registration.townhall.bctextengine _textengine) throws Exception{
innerInitialize(_ba);
...
public anywheresoftware.b4a.objects.collections.List  _parse(bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _t = null;
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _n = null;
...
public bwsi.registration.townhall.bbcodeparser._bbcodetagnode  _parsetag(String _tag) throws Exception{
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _res = null;
int _i = 0;
int _last = 0;
String _c = "";
String _key = "";
...
public void  _setimageview(bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag,bwsi.registration.townhall.bctextengine._bctextrun _run,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
public ResumableSub_SetImageView(bwsi.registration.townhall.bbcodeparser parent,bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag,bwsi.registration.townhall.bctextengine._bctextrun _run,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) {
this.parent = parent;
this._tag = _tag;
this._run = _run;
this._data = _data;
}
bwsi.registration.townhall.bbcodeparser parent;
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag;
bwsi.registration.townhall.bctextengine._bctextrun _run;
bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data;
String _url = "";
String _dir = "";
String _filename = "";
int _width = 0;
...
bwsi.registration.townhall.httpjob _j = null;
...
_j = new bwsi.registration.townhall.httpjob();
...
//C
this.state = 9;
_j = (bwsi.registration.townhall.httpjob) result[0];
;
...
public void  _jobdone(bwsi.registration.townhall.httpjob _j) throws Exception{
}
public bwsi.registration.townhall.bbcodeparser._bbcodetagnode  _stackpeek() throws Exception{
...
if (true) return (bwsi.registration.townhall.bbcodeparser._bbcodetagnode)(_stack.Get((int) (_stack.getSize()-1)));
...
public String  _stackpush(bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag) throws Exception{
...
public String  _texttorun(bwsi.registration.townhall.bbcodeparser._bbcodetextnode _text,anywheresoftware.b4a.objects.collections.List _runslist,bwsi.registration.townhall.bbcodeparser._bbcodeparsedata _data) throws Exception{
...
int _i = 0;
bwsi.registration.townhall.bbcodeparser._bbcodetagnode _tag = null;
bwsi.registration.townhall.bctextengine._bcstyledunderline _uu = null;
String _url = "";
String _clr = "";
String _name = "";
...
_run = _mtextengine._createrun /*bwsi.registration.townhall.bctextengine._bctextrun*/ (_text.Text /*String*/ );
...
_uu = new bwsi.registration.townhall.bctextengine._bcstyledunderline();
 //BA.debugLineNum = 206;BA.debugLine="uu.Initialize";
_uu.Initialize();
 //BA.debugLineNum = 207;BA.debugLine="uu.Style = tag.Extra.GetDefault(\"style\", mTex";
_uu.Style /*String*/  = BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .GetDefault((Object)("style"),(Object)(_mtextengine._defaultunderlinestyle /*bwsi.registration.townhall.bctextengine._bcstyledunderline*/ .Style /*String*/ )));
...
__c.LogImpl("935848252","Font missing from TextEngine.CustomFonts: "+_name,0);
 }else {
...
_parent = (bwsi.registration.townhall.bctextengine._bctextrun)(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("run")));
...
_run.TextChars /*bwsi.registration.townhall.bctextengine._bctextchars*/  = _mtextengine._createbctextchars /*bwsi.registration.townhall.bctextengine._bctextchars*/ (new String[]{BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))},(int) (0),(int) (1));
...
_run.TextChars /*bwsi.registration.townhall.bctextengine._bctextchars*/  = _mtextengine._createbctextcharsfromstring /*bwsi.registration.townhall.bctextengine._bctextchars*/ (BA.ObjectToString(__c.Chr(_parsecodepoint(BA.ObjectToString(_tag.Extra /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_tag.Tag /*String*/ )))))));

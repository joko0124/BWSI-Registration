...
views.get("clvemployees").vw.setHeight((int)((views.get("pnlmain").vw.getHeight())-(5d / 100 * height) - ((views.get("pnlsearchanchor").vw.getTop() + views.get("pnlsearchanchor").vw.getHeight())+(5d * scale))));

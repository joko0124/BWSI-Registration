...
public class starter extends  android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "bwsi.registration.yearend", "bwsi.registration.yearend.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.registration.yearend.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
anywheresoftware.b4a.keywords.Common.LogImpl("616449537",_rtp.GetSafeDirDefaultExternal(""),0);

...
public static bwsi.registration.yearend.b4xbitset  _createbitset(anywheresoftware.b4a.BA _ba,int _size) throws Exception{
bwsi.registration.yearend.b4xbitset _s = null;
...
_s = new bwsi.registration.yearend.b4xbitset();
...
public static bwsi.registration.yearend.b4xorderedmap  _createorderedmap(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static bwsi.registration.yearend.b4xorderedmap  _createorderedmap2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _keys,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
bwsi.registration.yearend.b4xorderedmap _m = null;
int _i = 0;
...
_m = new bwsi.registration.yearend.b4xorderedmap();
...
public static bwsi.registration.yearend.b4xset  _createset(anywheresoftware.b4a.BA _ba) throws Exception{
...
public static bwsi.registration.yearend.b4xset  _createset2(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.collections.List _values) throws Exception{
bwsi.registration.yearend.b4xset _s = null;
Object _v = null;
...
_s = new bwsi.registration.yearend.b4xset();

...
public class customlistview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.yearend.customlistview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.yearend.customlistview.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("613565954","AddTextItem is only supported in vertical orientation.",0);
...
public ResumableSub_PanelClickHandler(bwsi.registration.yearend.customlistview parent,anywheresoftware.b4a.objects.B4XViewWrapper _senderpanel) {
this.parent = parent;
this._senderpanel = _senderpanel;
}
bwsi.registration.yearend.customlistview parent;

...
anywheresoftware.b4a.objects.drawable.ColorDrawable _drwpressedcolor = null;
 //BA.debugLineNum = 28;BA.debugLine="Public Sub CreateButtonColor(FocusedColor As Int,";
 //BA.debugLineNum = 30;BA.debugLine="Dim RetColor As StateListDrawable";
_retcolor = new anywheresoftware.b4a.objects.drawable.StateListDrawable();
 //BA.debugLineNum = 31;BA.debugLine="RetColor.Initialize";
_retcolor.Initialize();
 //BA.debugLineNum = 32;BA.debugLine="Dim drwFocusedColor, drwEnabledColor, drwDisabled";
...
anywheresoftware.b4a.objects.drawable.ColorDrawable _mcd = null;
 //BA.debugLineNum = 57;BA.debugLine="Public Sub myCD As ColorDrawable";
 //BA.debugLineNum = 58;BA.debugLine="Dim mCD As ColorDrawable";
_mcd = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 59;BA.debugLine="mCD.Initialize(Colors.RGB(240,240,240),0)";
_mcd.Initialize(anywheresoftware.b4a.keywords.Common.Colors.RGB((int) (240),(int) (240),(int) (240)),(int) (0));
 //BA.debugLineNum = 60;BA.debugLine="Return mCD";
if (true) return _mcd;
...
_totemployees = 0;
 //BA.debugLineNum = 20;BA.debugLine="Public PosColor = 0xFF007BFF As Double";
_poscolor = 0xff007bff;
 //BA.debugLineNum = 21;BA.debugLine="Public NegColor = 0xFFDC3545 As Double";
_negcolor = 0xffdc3545;
 //BA.debugLineNum = 22;BA.debugLine="Public NeutralColor = 0xFF7FBDFF As Double";
_neutralcolor = 0xff7fbdff;
 //BA.debugLineNum = 24;BA.debugLine="Public Font As Typeface = Typeface.LoadFromAssets";
...
_font = (anywheresoftware.b4a.keywords.constants.TypefaceWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.keywords.constants.TypefaceWrapper(), (android.graphics.Typeface)(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("myfont.ttf")));
 //BA.debugLineNum = 25;BA.debugLine="Public FontBold As Typeface = Typeface.LoadFromAs";

...
public class addguest extends androidx.appcompat.app.AppCompatActivity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "bwsi.registration.yearend", "bwsi.registration.yearend.addguest");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "bwsi.registration.yearend", "bwsi.registration.yearend.addguest");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "bwsi.registration.yearend.addguest", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static bwsi.registration.yearend.slinptypeconst _inptyp = null;
...
anywheresoftware.b4a.keywords.Common.LogImpl("633685510",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
public ResumableSub_Printer_Connected(bwsi.registration.yearend.addguest parent,boolean _success) {
this.parent = parent;
this._success = _success;
}
bwsi.registration.yearend.addguest parent;
boolean _success;
...
anywheresoftware.b4a.keywords.Common.LogImpl("633882113","Connected: "+BA.ObjectToString(_success),0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("633882130",parent._devicename,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("633882146",parent._printbuffer,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("633751057",mostCurrent._starter._strcriteria /*String*/ ,anywheresoftware.b4a.keywords.Common.Colors.Magenta);
...
anywheresoftware.b4a.keywords.Common.LogImpl("633751089",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
_inptyp = new bwsi.registration.yearend.slinptypeconst();
...
anywheresoftware.b4a.keywords.Common.LogImpl("633030176",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };
...
anywheresoftware.b4a.keywords.Common.LogImpl("633816598",_devicename+" -> "+_devicemac,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("633816614",_devicename+" -> "+_devicemac,0);
...
anywheresoftware.b4a.keywords.Common.LogImpl("631653914",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
 };

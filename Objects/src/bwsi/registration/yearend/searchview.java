...
public class searchview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.yearend.searchview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.yearend.searchview.class).invoke(this, new Object[] {null});
        else
...
_it = (bwsi.registration.yearend.searchview._item)(group2.Get(index2));
...
_it = (bwsi.registration.yearend.searchview._item)(_value);
...
_it = (bwsi.registration.yearend.searchview._item)(group11.Get(index11));
...
__c.LogImpl("68060963","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);

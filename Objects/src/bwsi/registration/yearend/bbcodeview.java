...
public class bbcodeview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.registration.yearend.bbcodeview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.registration.yearend.bbcodeview.class).invoke(this, new Object[] {null});
        else
...
public bwsi.registration.yearend.bctextengine._bcparagraphstyle _style = null;
...
public bwsi.registration.yearend.bctextengine._bcparagraph _paragraph = null;
...
public bwsi.registration.yearend.bbcodeparser._bbcodeparsedata _parsedata = null;
public Object _tag = null;
public boolean _lazyloading = false;
public anywheresoftware.b4a.objects.collections.List _imageviewscache = null;
public bwsi.registration.yearend.b4xorderedmap _usedimageviews = null;
...
_style = new bwsi.registration.yearend.bctextengine._bcparagraphstyle();
...
_paragraph = new bwsi.registration.yearend.bctextengine._bcparagraph();
...
_parsedata = new bwsi.registration.yearend.bbcodeparser._bbcodeparsedata();
...
_usedimageviews = new bwsi.registration.yearend.b4xorderedmap();
...
_usedimageviews = _b4xcollections._createorderedmap /*bwsi.registration.yearend.b4xorderedmap*/ (ba);
 };
...
public bwsi.registration.yearend.bctextengine  _gettextengine() throws Exception{
...
public boolean  _lineisvisible(bwsi.registration.yearend.bctextengine._bctextline _line,int _offset,int _height) throws Exception{
...
_pe = _mtextengine._tagparser /*bwsi.registration.yearend.bbcodeparser*/ ._parse /*anywheresoftware.b4a.objects.collections.List*/ (_parsedata);
...
_runs = _mtextengine._tagparser /*bwsi.registration.yearend.bbcodeparser*/ ._createruns /*anywheresoftware.b4a.objects.collections.List*/ (_pe,_parsedata);
 };
...
_style = _mtextengine._createstyle /*bwsi.registration.yearend.bctextengine._bcparagraphstyle*/ ();
...
_paragraph = _mtextengine._prepareforlazydrawing /*bwsi.registration.yearend.bctextengine._bcparagraph*/ (_runs,_style,_sv);
...
_paragraph = _mtextengine._drawtext /*bwsi.registration.yearend.bctextengine._bcparagraph*/ (_runs,_style,_foregroundimageview,_sv);
 };
...
public String  _settextengine(bwsi.registration.yearend.bctextengine _b) throws Exception{
...
_single = _mtextengine._findsinglestylesection /*bwsi.registration.yearend.bctextengine._bcsinglestylesection*/ (_paragraph,(int) (_x),(int) (_y));
...
if (_parsedata.URLs /*anywheresoftware.b4a.objects.collections.Map*/ .ContainsKey((Object)(_single.Run /*bwsi.registration.yearend.bctextengine._bctextrun*/ ))) { 
 //BA.debugLineNum = 230;BA.debugLine="Dim url As String = ParseData.Urls.Get(single.";
_url = BA.ObjectToString(_parsedata.URLs /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_single.Run /*bwsi.registration.yearend.bctextengine._bctextrun*/ )));
...
_line = (bwsi.registration.yearend.bctextengine._bctextline)(group6.Get(index6));
...
if (BA.fastSubCompare(sub, "SETTEXTENGINE"))
	return _settextengine((bwsi.registration.yearend.bctextengine) args[0]);
